function countUp(t, e, i, o, s, n) {
    ...
    let a = 0;
    var r = ["webkit", "moz", "ms"];
    for (let t = 0; t < r.length && !window.requestAnimationFrame; ++t) window.requestAnimationFrame = window[r[t] + "RequestAnimationFrame"], window.cancelAnimationFrame = window[r[t] + "CancelAnimationFrame"] || window[r[t] + "CancelRequestAnimationFrame"];
    ...
    const l = this;
    this.d = "string" == typeof t ? document.getElementById(t) : t, this.startVal = Number(e), this.endVal = Number(i), this.countDown = this.startVal > this.endVal, this.startTime = null, this.timestamp = null, this.remaining = null, this.frameVal = this.startVal, this.rAF = null, this.decimals = Math.max(0, o || 0), this.dec = Math.pow(10, this.decimals), this.duration = 1e3 * s || 2e3, this.easeOutExpo = function(t, e, i, o) {
        return i * (1 - Math.pow(2, -10 * t / o)) * 1024 / 1023 + e
    }, this.count = function(t) {
        null === l.startTime && (l.startTime = t);
        var e, t = (l.timestamp = t) - l.startTime;
        l.remaining = l.duration - t, l.options.useEasing ? l.countDown ? (e = l.easeOutExpo(t, 0, l.startVal - l.endVal, l.duration), l.frameVal = l.startVal - e) : l.frameVal = l.easeOutExpo(t, l.startVal, l.endVal - l.startVal, l.duration) : l.countDown ? (e = (l.startVal - l.endVal) * (t / l.duration), l.frameVal = l.startVal - e) : l.frameVal = l.startVal + (l.endVal - l.startVal) * (t / l.duration), l.frameVal = Math.round(l.frameVal * l.dec) / l.dec, l.countDown ? l.frameVal = l.frameVal < l.endVal ? l.endVal : l.frameVal : l.frameVal = l.frameVal > l.endVal ? l.endVal : l.frameVal, l.d.innerHTML = l.formatNumber(l.frameVal.toFixed(l.decimals)), t < l.duration ? l.rAF = requestAnimationFrame(l.count) : null != l.callback && l.callback()
    }, this.start = function(t) {
        return l.callback = t, isNaN(l.endVal) || isNaN(l.startVal) ? (console.log("countUp error: startVal or endVal is not a number"), l.d.innerHTML = "--") : l.rAF = requestAnimationFrame(l.count), !1
    }, this.stop = function() {
        cancelAnimationFrame(l.rAF)
    }, this.reset = function() {
        l.startTime = null, cancelAnimationFrame(l.rAF), l.d.innerHTML = l.formatNumber(l.startVal.toFixed(l.decimals))
    }, this.resume = function() {
        l.startTime = null, l.duration = l.remaining, l.startVal = l.frameVal, requestAnimationFrame(l.count)
    }, this.formatNumber = function(t) {
        let e, i, o, s;
        if (e = (t += "").split("."), i = e[0], o = 1 < e.length ? l.options.decimal + e[1] : "", s = /(\d+)(\d{3})/, l.options.useGrouping)
...
function recallme() {
    jQuery(".ult_dual_button").each(function(t) {
        ...
        jQuery("body").hasClass("rtl") && (l = "right"), "on" == i ? (r = e, (r = document.createElement("style")).type = "text/css", r.innerHTML = "@media(min-width:300px) and (max-width:768px) {#" + e + ".ult_dual_button .ulitmate_dual_buttons .ult_dualbutton-wrapper { margin: 0px;float: none;position: relative}.ult_main_dualbtn { display: inline-block}.ult_dualbutton-wrapper { display: block }#" + e + ".ult_dual_button .middle-text {top: 100%;right: 50%}#" + e + ".ult_dual_button .ulitmate_dual_buttons .ult_dualbutton-wrapper:first-child .ult_ivan_button { border-bottom-right-radius: 0!important; border-bottom-left-radius: 0!important; border-top-right-radius: inherit; border-bottom: 0px!important;}#" + e + ".ult_dual_button .ulitmate_dual_buttons .ult_dualbutton-wrapper:last-child .ult_ivan_button { border-top-left-radius: 0!important;border-top-right-radius: 0!important}}@media(min-width:0px) and (max-width:0px) {#" + e + ".ult_dual_button .ulitmate_dual_buttons .ult_dualbutton-wrapper { float: left; position: relative}.ult_dual1 {     border-right: none!important } .ult_dualbutton-wrapper {display: block}#" + e + ".ult_dual_button .ulitmate_dual_buttons .ult_dualbutton-wrapper:first-child .ult_ivan_button { border-top-right-radius: 0!important;  border-bottom-right-radius: 0!important}#" + e + ".ult_dual_button .ulitmate_dual_buttons .ult_dualbutton-wrapper:last-child .ult_ivan_button { border-top-left-radius: 0!important;  border-bottom-left-radius: 0!important  }}@media(min-width:768px) and (max-width:970px) { #" + e + ".ult_dual_button .ulitmate_dual_buttons .ult_dualbutton-wrapper { margin: -4px; float: none; position: relative }.ult_dualbutton-wrapper { display: block} #" + e + ".ult_dual_button .middle-text { top: 100%; right: 50% }#" + e + ".ult_dual_button .ulitmate_dual_buttons .ult_dualbutton-wrapper:first-child .ult_ivan_button { border-bottom-right-radius: 0!important; border-bottom-left-radius: 0!important; border-top-right-radius: inherit }#" + e + ".ult_dual_button .ulitmate_dual_buttons .ult_dualbutton-wrapper:last-child .ult_ivan_button {     border-top-left-radius: 0!important;   border-top-right-radius: 0!important  }}@media(min-width:970px){ #" + e + ".ult_dual_button .ulitmate_dual_buttons .ult_dualbutton-wrapper:first-child .ult_ivan_button { border-top-" + o + "-radius: 0!important; border-bottom-" + o + "-radius: 0!important}#" + e + ".ult_dual_button .ulitmate_dual_buttons .ult_dualbutton-wrapper:last-child .ult_ivan_button { border-top-" + l + "-radius: 0!important; border-bottom-" + l + "-radius: 0!important }#" + e + ".ult_dual_button .ult_dual1 { border-" + o + ": none!important}}", document.getElementsByTagName("head")[0].appendChild(r), document.getElementsByTagName("head")[0].appendChild(r), s = jQuery(window).width(), l = jQuery(this).find(".ult_dual1").outerWidth(), o = jQuery(this).find(".ult_dual2").outerWidth(), a = 300 < s && s <= 768 || 768 < s && s < 1015 ? (n = "inset 0px -" + l + "px 0px 0px ", " inset 0px " + o + "px 0px 0px ") : (n = "inset -" + l + "px 0 0 0 ", "inset " + o + "px 0 0 0"), jQuery("#" + e).find(".ult_dual1").mouseenter(function() {
            ...
            var t = (e = jQuery(this).find(".ult-dual-btn-2").attr("class")).split(" "),
                e = t[1] + t[2],
                t = jQuery(this).outerWidth();
            "Style2" == e && (e = "inset " + t + "px 0 0 0", t = jQuery(this).find(".ult-dual-btn-2").data("bghovercolor"), jQuery(this).css({
                "box-shadow": e + t
            }))
        }), jQuery("#" + e).find(".ult_dual2").mouseleave(function() {
            var t = jQuery(this).find(".ult-dual-btn-2").attr("class").split(" ");
    ...
    function e() {
        u(".ult-content-box").each(function(t, e) {
            ...
            c = void 0 !== d && null != d ? f(d) : function(t) {
                const e = {};
                e["margin-left"] = p(u(t).css("margin-left")), e["margin-right"] = p(u(t).css("margin-right")), e["margin-top"] = p(u(t).css("margin-top")), e["margin-bottom"] = p(u(t).css("margin-bottom"));
                let i = "";
                return u.each(e, function(t, e) {
                    void 0 !== e && null != e && (i += t + ":" + e + "px;")
                }), u(t).attr("data-normal_margins", i), e
            }(e);
            d = u(h).width() || "";
            "" != d && m(768 <= d ? c : l, e)
        })
    ...
    function f(t) {
        const o = {};
        t = t.split(";");
        return void 0 !== t && null != t && u.each(t, function(t, e) {
            if (typeof e !== s && null != e) {
                var i = e.split(":");
                if (typeof i[0] !== s && null != i[0] && typeof i[1] !== s && null != i[1]) switch (i[0]) {
                    case "margin":
                        o.margin = i[1];
                        break;
                    case "margin-left":
    ...
    function m(t, i) {
        u.isEmptyObject(t) || u.each(t, function(t, e) {
...
}(jQuery, window), jQuery(window).on("load", function() {
        ! function() {
            let u = "",
                h = "",
                p = "",
            ...
            jQuery(".ult-responsive").each(function(t, e) {
                let i = jQuery(e),
                    ...
                    d = "",
                    c = "";
                void 0 === o && null == o || jQuery.each(jQuery.parseJSON(o), function(t, e) {
                    const o = t;
                    void 0 !== e && null != e && (e = e.split(";"), jQuery.each(e, function(t, e) {
                        if (void 0 !== e || null != e) {
                            var i = e.split(":");
                            switch (i[0]) {
                                case "large_screen":
                ...
                }), "" != c && (y += s + "{" + c + "}"), "" != d && (m += s + "{" + d + "}"), "" != l && (f += s + "{" + l + "}"), "" != r && (p += s + "{" + r + "}"), "" != a && (h += s + "{" + a + "}"), "" != n && (u += s + "{" + n + "}")
            });
            var t = "<style>\n/** Ultimate: CountDown Responsive **/ ";
            t += h, t += "\n@media (min-width: 1824px) { " + u + "\n}", t += "\n@media (max-width: 1199px) { " + p + "\n}", t += "\n@media (max-width: 991px)  { " + f + "\n}", t += "\n@media (max-width: 767px)  { " + m + "\n}", t += "\n@media (max-width: 479px)  { " + y + "\n}", t += "\n/** Ultimate: Tooltipster Responsive - **/</style>", jQuery("head").append(t)
            ...
            function n(t) {
                ...
                }), n.addClass("ult-responsive"), n.css({
                    "font-family": r,
                    "border-width": d,
                    "border-style": c,
                    "border-radius": u,
    ...
    function() {
        ...
        window.JQClass = function() {}, JQClass.classes = {}, JQClass.extend = function t(e) {
            ...
            const i = new this;
            a = !1;
            for (const n in e) i[n] = "function" == typeof e[n] && "function" == typeof s[n] ? function(i, o) {
                return function() {
                    var t = this._super;
    ...
    function($) {
        ...
        JQClass.classes.JQPlugin = JQClass.extend({
            ...
            _attach(t, e) {
                var i;
                (t = $(t)).hasClass(this._getMarker()) || (t.addClass(this._getMarker()), e = $.extend({}, this.defaultOptions, this._getMetadata(t), e || {}), i = $.extend({
                    name: this.name,
                    elem: t,
                    options: e
                }, this._instSettings(t, e)), t.data(this.name, i), this._postAttach(t, i), this.option(t, e))
            },
            _instSettings(t, e) {
                return {}
            },
            ...
            option(t, e, i) {
                var o, s = (t = $(t)).data(this.name);
                if (!e || "string" == typeof e && null == i) return (o = (s || {}).options) && e ? o[e] : o;
                t.hasClass(this._getMarker()) && (o = e || {}, "string" == typeof e && ((o = {})[e] = i), this._optionsChanged(t, s, o), $.extend(s.options, o))
            },
    ...
    function(p) {
        ...
        p.JQPlugin.createPlugin({
            ...
            _init: function() {
                ...
                var n = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || null,
                    a = 0;
                !n || p.noRequestAnimationFrame ? (p.noRequestAnimationFrame = null, p.countdown._timer = setInterval(function() {
                    i._updateElems()
                }, 1e3)) : (a = window.animationStartTime || window.webkitAnimationStartTime || window.mozAnimationStartTime || window.oAnimationStartTime || window.msAnimationStartTime || o(), n(function t(e) {
                    e = e < 1e12 ? s ? window.performance.now() + window.performance.timing.navigationStart : o() : e || o();
                    1e3 <= e - a && (i._updateElems(), a = e), n(t)
                }))
            },
            UTCDate: function(t, e, i, o, s, n, a, r) {
                "object" == typeof e && e instanceof Date && (r = e.getMilliseconds(), a = e.getSeconds(), n = e.getMinutes(), s = e.getHours(), o = e.getDate(), i = e.getMonth(), e = e.getFullYear());
                var l = new Date;
                return l.setUTCFullYear(e), l.setUTCDate(1), l.setUTCMonth(i || 0), l.setUTCDate(o || 1), l.setUTCHours(s || 0), l.setUTCMinutes((n || 0) - (Math.abs(t) < 30 ? 60 * t : t)), l.setUTCSeconds(a || 0), l.setUTCMilliseconds(r || 0), l
            },
                    ...
                    if (t.options.serverSync) {
                        for (var e, i = null, o = 0; o < s._serverSyncs.length; o++)
                            if (s._serverSyncs[o][0] === t.options.serverSync) {
                                i = s._serverSyncs[o];
                                break
                            } s._eqNull(i[2]) && (e = p.isFunction(t.options.serverSync) ? t.options.serverSync.apply(this, []) : null, i[2] = (e ? (new Date).getTime() - e.getTime() : 0) - i[1]), t._since && t._since.setMilliseconds(t._since.getMilliseconds() + i[2]), t._until.setMilliseconds(t._until.getMilliseconds() + i[2])
                    }
                });
            ...
            _optionsChanged: function(t, e, i) {
                ...
                p.extend(e.options, i), this._adjustSettings(t, e, !this._eqNull(i.until) || !this._eqNull(i.since) || o);
                o = new Date;
                (e._since && e._since < o || e._until && e._until > o) && this._addElem(t[0]), this._updateCountdown(t, e)
            },
            _updateCountdown: function(t, e) {
                var i;
                t = t.jquery ? t : p(t), (e = e || this._getInst(t)) && (t.html(this._generateHTML(e)).toggleClass(this._rtlClass, e.options.isRTL), "pause" !== e._hold && p.isFunction(e.options.onTick) && (i = "lap" !== e._hold ? e._periods : this._calculatePeriods(e, e._show, e.options.significant, new Date), 1 !== e.options.tickInterval && this.periodsToSeconds(i) % e.options.tickInterval != 0 || e.options.onTick.apply(t[0], [i])), "pause" !== e._hold && (e._since ? e._now.getTime() < e._since.getTime() : e._now.getTime() >= e._until.getTime()) && !e._expiring ? (e._expiring = !0, (this._hasElem(t[0]) || e.options.alwaysExpire) && (this._removeElem(t[0]), p.isFunction(e.options.onExpiry) && e.options.onExpiry.apply(t[0], []), e.options.expiryText && (i = e.options.layout, e.options.layout = e.options.expiryText, this._updateCountdown(t[0], e), e.options.layout = i), e.options.expiryUrl && (window.location = e.options.expiryUrl)), e._expiring = !1) : "pause" === e._hold && this._removeElem(t[0]))
            },
            ...
            _adjustSettings: function(t, e, i) {
                for (var o = null, s = 0; s < this._serverSyncs.length; s++)
                    ...
                    a = null;
                this._eqNull(o) ? (r = p.isFunction(e.options.serverSync) ? e.options.serverSync.apply(t[0], []) : null, n = new Date, a = r ? n.getTime() - r.getTime() : 0, this._serverSyncs.push([e.options.serverSync, a])) : (n = new Date, a = e.options.serverSync ? o : 0);
                var r = e.options.timezone,
                    r = this._eqNull(r) ? -n.getTimezoneOffset() : r;
                (i || !i && this._eqNull(e._until) && this._eqNull(e._since)) && (e._since = e.options.since, this._eqNull(e._since) || (e._since = this.UTCDate(r, this._determineTime(e._since, null)), e._since && a && e._since.setMilliseconds(e._since.getMilliseconds() + a)), e._until = this.UTCDate(r, this._determineTime(e.options.until, n)), a && e._until.setMilliseconds(e._until.getMilliseconds() + a)), e._show = this._determineShow(e)
            },
            ...
            _hold: function(t, e) {
                var i, o = p.data(t, this.name);
                o && ("pause" !== o._hold || e || (o._periods = o._savePeriods, i = o._since ? "-" : "+", o[o._since ? "_since" : "_until"] = this._determineTime(i + o._periods[0] + "y" + i + o._periods[1] + "o" + i + o._periods[2] + "w" + i + o._periods[3] + "d" + i + o._periods[4] + "h" + i + o._periods[5] + "m" + i + o._periods[6] + "s"), this._addElem(t)), o._hold = e, o._savePeriods = "pause" === e ? o._periods : null, p.data(t, this.name, o), this._updateCountdown(t, o))
            },
            getTimes: function(t) {
            ...
            _determineTime: function(t, e) {
                var i, o, c = this,
                    t = this._eqNull(t) ? e : "string" == typeof t ? function(t) {
                        t = t.toLowerCase();
                        for (var e = new Date, i = e.getFullYear(), o = e.getMonth(), s = e.getDate(), n = e.getHours(), a = e.getMinutes(), r = e.getSeconds(), l = /([+-]?[0-9]+)\s*(s|m|h|d|w|o|y)?/g, d = l.exec(t); d;) {
                            switch (d[2] || "s") {
                                case "s":
                                    r += parseInt(d[1], 10);
                                    break;
                    ...
                    }(t) : "number" == typeof t ? (i = t, (o = new Date).setTime(o.getTime() + 1e3 * i), o) : t;
            ...
            _generateHTML: function(i) {
                ...
                for (var t = !1, e = 0, s = i.options.significant, n = p.extend({}, i._show), a = null, a = 0; a <= 6; a++) t = t || "?" === i._show[a] && 0 < i._periods[a], n[a] = "?" !== i._show[a] || t ? i._show[a] : null, e += n[a] ? 1 : 0, s -= 0 < i._periods[a] ? 1 : 0;
                var r = [!1, !1, !1, !1, !1, !1, !1];
                ...
                function d(t) {
                    ...
                    return !i.options.significant && n[t] || i.options.significant && r[t] ? '<span class="' + o._sectionClass + '"><span class="' + o._amountClass + '">' + o._minDigits(i, i._periods[t], h) + '</span><span class="' + o._periodClass + '">' + (e || c)[t] + "</span></span>" : ""
                }
                ...
                return i.options.layout ? this._buildLayout(i, n, i.options.layout, i.options.compact, i.options.significant, r) : (i.options.compact ? '<span class="' + this._rowClass + " " + this._amountClass + (i._hold ? " " + this._holdingClass : "") + '">' + l(0) + l(1) + l(2) + l(3) + (n[4] ? this._minDigits(i, i._periods[4], 2) : "") + (n[5] ? (n[4] ? i.options.timeSeparator : "") + this._minDigits(i, i._periods[5], 2) : "") + (n[6] ? (n[4] || n[5] ? i.options.timeSeparator : "") + this._minDigits(i, i._periods[6], 2) : "") : '<span class="' + this._rowClass + " " + this._showClass + (i.options.significant || e) + (i._hold ? " " + this._holdingClass : "") + '">' + d(0) + d(1) + d(2) + d(3) + d(4) + d(5) + d(6)) + "</span>" + (i.options.description ? '<span class="' + this._rowClass + " " + this._descrClass + '">' + i.options.description + "</span>" : "")
            },
            _buildLayout: function(i, t, e, o, s, n) {
                for (var a = i.options[o ? "compactLabels" : "labels"], r = i.options.whichLabels || this._normalLabels, l = function(t) {
                    ...
                    }, c = e, u = 0; u <= 6; u++) var h = "yowdhms".charAt(u),
                    h = new RegExp("\\{" + h + "<\\}([\\s\\S]*)\\{" + h + ">\\}", "g"),
                    c = c.replace(h, !s && t[u] || s && n[u] ? "$1" : "");
                return p.each(d, function(t, e) {
                    t = new RegExp("\\{" + t + "\\}", "g");
                    c = c.replace(t, e)
                }), c
            },
            _minDigits: function(t, e, i) {
                return (e = "" + e).length >= i ? this._translateDigits(t, e) : this._translateDigits(t, (e = "0000000000" + e).substr(e.length - i))
            },
            ...
            _determineShow: function(t) {
                var e = t.options.format,
                    t = [];
                return t[0] = e.match("y") ? "?" : e.match("Y") ? "!" : null, t[1] = e.match("o") ? "?" : e.match("O") ? "!" : null, t[2] = e.match("w") ? "?" : e.match("W") ? "!" : null, t[3] = e.match("d") ? "?" : e.match("D") ? "!" : null, t[4] = e.match("h") ? "?" : e.match("H") ? "!" : null, t[5] = e.match("m") ? "?" : e.match("M") ? "!" : null, t[6] = e.match("s") ? "?" : e.match("S") ? "!" : null, t
            },
            _calculatePeriods: function(t, i, e, o) {
                t._now = o, t._now.setMilliseconds(0);
                var s = new Date(t._now.getTime());
                t._since ? o.getTime() < t._since.getTime() ? t._now = o = s : o = t._since : (s.setTime(t._until.getTime()), o.getTime() > t._until.getTime() && (t._now = o = s));
                var n, a, r, l = [0, 0, 0, 0, 0, 0, 0];
                (i[0] || i[1]) && (r = this._getDaysInMonth(o.getFullYear(), o.getMonth()), a = this._getDaysInMonth(s.getFullYear(), s.getMonth()), n = s.getDate() === o.getDate() || s.getDate() >= Math.min(r, a) && o.getDate() >= Math.min(r, a), a = function(t) {
                    return 60 * (60 * t.getHours() + t.getMinutes()) + t.getSeconds()
                }, a = Math.max(0, 12 * (s.getFullYear() - o.getFullYear()) + s.getMonth() - o.getMonth() + (s.getDate() < o.getDate() && !n || n && a(s) < a(o) ? -1 : 0)), l[0] = i[0] ? Math.floor(a / 12) : 0, l[1] = i[1] ? a - 12 * l[0] : 0, a = (o = new Date(o.getTime())).getDate() === r, r = this._getDaysInMonth(o.getFullYear() + l[0], o.getMonth() + l[1]), o.getDate() > r && o.setDate(r), o.setFullYear(o.getFullYear() + l[0]), o.setMonth(o.getMonth() + l[1]), a && o.setDate(r));
                ...
                if (o(2, 604800), o(3, 86400), o(4, 3600), o(5, 60), o(6, 1), 0 < d && !t._since)
                    for (var u = [1, 12, 4.3482, 7, 24, 60, 60], h = 6, p = 1, c = 6; 0 <= c; c--) i[c] && (l[h] >= p && (l[h] = 0, d = 1), 0 < d && (l[c]++, d = 0, h = c, p = 1)), p *= u[c];
                if (e)
                    for (c = 0; c <= 6; c++) e && l[c] ? e-- : e || (l[c] = 0);
                return l
            }
        })
        ...
        jQuery(".ult_colorlink").hover(function() {
            ...
            "Style_6" == t && (e = jQuery(this).find(".ult_btn6_link_top").data("color"), jQuery(this).find(".ult_btn6_link_top").css("text-shadow", "10px 0 " + e + ", -10px 0 " + e), jQuery(this).find(".ult_btn6_link_top").css("color", e)), "Style_10" == t && (i = jQuery(this).find(".ult_btn10_span").data("bhover"), " " != jQuery(this).find(".ult_btn10_span").data("bstyle") && (jQuery(this).find(".ult_btn10_span").css("border-top-style", "solid"), jQuery(this).find(".ult_btn10_span").css("border-top-color", i)));
            var e = jQuery(this).data("texthover"),
                i = jQuery(this).data("bghover");
            jQuery(this).css("color", e), jQuery(this).find(".ult_btn10_span").css("color", e), "Style_2" == t && jQuery(this).find(".ult_btn10_span").css("background", i)
        }, function() {
            var t = jQuery(this).data("style");
            "Style_6" == t && jQuery(this).find(".ult_btn6_link_top").removeAttr("style"), "Style_10" == t && (i = jQuery(this).find(".ult_btn10_span").data("color"), " " != (e = jQuery(this).find(".ult_btn10_span").data("bstyle")) && (jQuery(this).find(".ult_btn10_span").css("border-top-style", e), jQuery(this).find(".ult_btn10_span").css("border-top-color", i)));
    ...
    function(c) {
        ...
        function s(t, e) {
            var i, o;
            i = parseInt(e.outerHeight()), t.css("padding-top", (o = i / 2) + "px"), t.parent().css("margin-top", o + 20 + "px"), e.css("top", -i + "px")
        }
        ...
        function n(t) {
            0 < t.find(".timeline-icon-block").length && c(".timeline-block").each(function(t, e) {
                ...
                c(this).hasClass("timeline-post-left") ? (o.css({
                    left: a,
                    right: "auto"
                }), jQuery("body").hasClass("rtl") && o.css({
                    left: "auto",
                    right: a
                })) : c(this).hasClass("timeline-post-right") && (o.css({
                    left: "auto",
                    right: a
                }), jQuery("body").hasClass("rtl") && o.css({
                    left: a,
            ...
            jQuery(".ult-animation").each(function() {
                if (jQuery(this).attr("data-animate")) {
                    ...
                    const n = jQuery(this).attr("data-animate"),
                        ...
                        a = (jQuery(this).attr("data-opacity_start_effect"), "opacity:1;-webkit-animation-delay:" + s + "s;-webkit-animation-duration:" + t + ";-webkit-animation-iteration-count:" + o + "; -moz-animation-delay:" + s + "s;-moz-animation-duration:" + t + ";-moz-animation-iteration-count:" + o + "; animation-delay:" + s + "s;animation-duration:" + t + ";animation-iteration-count:" + o + ";");
                    var i = "opacity:1;-webkit-transition-delay: " + s + "s; -moz-transition-delay: " + s + "s; transition-delay: " + s + "s;";
                    if (r(jQuery(this))) {
                        ...
                        void 0 === t && (t = "test"), t = t.replace(/ /g, ""), "opacity:0;" == t && 0 !== t.indexOf(i) && jQuery(this).attr("style", i), jQuery.each(e, function(t, e) {
                            ...
                            void 0 === o && (o = "test");
                            let s = "";
                            s = 0 == o.indexOf(a) ? o : a + o, i.attr("style", s), r(i) && i.addClass("animated").addClass(n)
                        })
                    }
                }
            })
        ...
        function a() {
            ...
            t.each(function(t, e) {
                const i = jQuery(this);
                var o, s;
                i.hasClass("ult-ib-resp") && (o = jQuery(document).width(), s = i.data("min-width"), o <= i.data("max-width") && s <= o ? i.find(".ult-new-ib-content").hide() : i.find(".ult-new-ib-content").show())
            })
        }
        c.fn.vc_translate_row = function() {
            ...
            c(this).each(function(t, e) {
                ...
                if (i = void 0 === i ? "false" : i.toString(), "false" == ("true" == (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ? "true" : "false") && "true" == i ? "true" : "false")) {
                    ...
                    0 < o && (i = 1 - o), n <= s ? (i < 0 ? i = 0 : 1 < i && (i = 1), c(e).children().each(function(t, e) {
            ...
            ! function() {
                ...
                c(".ult-spacer").each(function(t, e) {
                    var i = c(e).data("id"),
                        ...
                        e = c(e).data("height");
                    "" != e && (r += " .spacer-" + i + " { height:" + e + "px } "), "" == n && "0" != n && 0 != n || (r += " @media (max-width: 1199px) { .spacer-" + i + " { height:" + n + "px } } "), void 0 === a || "" == a && "0" != a && 0 != a || (r += " @media (max-width: 991px) { .spacer-" + i + " { height:" + a + "px } } "), void 0 === s || "" == s && "0" != s && 0 != s || (r += " @media (max-width: 767px) { .spacer-" + i + " { height:" + s + "px } } "), "" == o && "0" != o && 0 != o || (r += " @media (max-width: 479px) { .spacer-" + i + " { height:" + o + "px } } ")
            ...
            jQuery(window).resize(function() {
                a(), jQuery(".csstime.smile-icon-timeline-wrap").each(function() {
                    ...
                    n(jQuery(this))
                }), "none" == jQuery(".smile-icon-timeline-wrap.jstime .timeline-line").css("display") ? 0 === o && (c(".jstime .timeline-wrapper").masonry("destroy"), o = 1) : 1 == o && (jQuery(".jstime .timeline-wrapper").masonry({
            ...
            /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && 1 <= e ? jQuery(".ult-animation").css("opacity", 1) : i(), a(), jQuery(".ubtn").on("mouseenter", function() {
                ...
                let i = t.attr("style");
                var o;
                "" != t.data("shadow-hover") && (t.css("box-shadow"), i += "box-shadow:" + t.data("shadow-hover")), t.attr("style", i), "" != t.data("border-hover") && t.css("border-color", t.data("border-hover")), "none" != t.data("shadow-click") && (o = t.data("shd-shadow") - 3, "" != t.is(".shd-left") ? t.css({
                    right: o
                ...
                const i = jQuery(this);
                var o;
                0 < jQuery(this).find(".aio-icon-img").length ? (o = jQuery(this).find(".aio-icon-img"), s(i, o), o.find(".img-icon").on("load", function() {
                    s(i, o)
                })) : (o = jQuery(this).find(".aio-icon"), s(i, o), jQuery(window).on("load", function() {
                    s(i, o)
                }))
            })
        })
        ...
        function t() {
            jQuery(".ult-new-ib").each(function(t, e) {
                var i, o = jQuery(this).data("min-height") || "";
                jQuery(this).find(".ult-new-ib-img").data("min-height"), jQuery(this).find(".ult-new-ib-img").data("max-width");
                "" != o && (jQuery(this).addClass("ult-ib2-min-height"), jQuery(this).css("height", o), jQuery(this).find(".ult-new-ib-img").removeClass("ult-ib2-toggle-size"), jQuery(this).find(".ult-new-ib-img").width(), i = jQuery(this).find(".ult-new-ib-img").height(), (jQuery(this).width() <= o || i < o) && jQuery(this).find(".ult-new-ib-img").addClass("ult-ib2-toggle-size")), jQuery(this).on("mouseenter", function() {
    ...
    function(o) {
        o(document).ready(function() {
            ...
            o(document).on("mouseenter", ".ult_dual1", function() {
                var t, e = o(this).find(".ult-dual-btn-1").attr("class"),
                    i = e.split(" ");
                "Style1" == (e = i[1] + i[2]) && (t = o(this).find(".ult-dual-btn-1").data("bghovercolor"), o(this)[0].style.setProperty("background-color", t, "important")), "Style2" == e && (t = o(this).find(".ult-dual-btn-1").data("bghovercolor")), "Style3" == e && (t = o(this).find(".ult-dual-btn-1").data("bghovercolor"), o(this).css({
                    "box-shadow": " inset 0 0 20px 50px " + t
                })), "undefined" != e && (t = o(this).find(".ult-dual-btn-1").data("icon_hover_color"), o(this).find(".ult-dual-btn-1").find(".aio-icon").css({
                    color: t
                }), e = o(this).find(".ult-dual-btn-1").data("iconbghovercolor"), o(this).find(".ult-dual-btn-1").find(".aio-icon").css({
                    background: e
                }), t = o(this).find(".ult-dual-btn-1").data("iconhoverborder"), o(this).find(".ult-dual-btn-1").find(".aio-icon").css({
                    "border-color": t
                }), o(this).find(".ult-dual-btn-1").find(".aio-icon-img").css({
                    background: e
                }), o(this).find(".ult-dual-btn-1").find(".aio-icon-img").css({
                    "border-color": t
                }), t = o(this).find(".ult-dual-btn-1").data("texthovercolor"), o(this).find(".ult-dual-btn-1").find(".ult-dual-button-title").css({
                    color: t
                }))
            }), o(document).on("mouseleave", ".ult_dual1", function() {
                var t, e = o(this).find(".ult-dual-btn-1").attr("class"),
                    i = e.split(" ");
                "Style1" == (e = i[1] + i[2]) && (t = o(this).find(".ult-dual-btn-1").data("bgcolor"), o(this)[0].style.setProperty("background-color", t, "important")), "Style2" == e && (t = o(this).find(".ult-dual-btn-1").data("bgcolor")), "Style3" == e && (t = o(this).find(".ult-dual-btn-1").data("bgcolor"), o(this).css({
                    "box-shadow": "inset 0px 0 0 0 " + t
                })), "undefined" != e && (t = o(this).find(".ult-dual-btn-1").data("icon_color"), o(this).find(".ult-dual-btn-1").find(".aio-icon").css({
                    color: t
                }), e = o(this).find(".ult-dual-btn-1").data("textcolor"), o(this).find(".ult-dual-btn-1").find(".ult-dual-button-title").css({
                    color: e
                }), t = o(this).find(".ult-dual-btn-1").data("iconbgcolor"), o(this).find(".ult-dual-btn-1").find(".aio-icon").css({
                    background: t
                }), e = o(this).find(".ult-dual-btn-1").data("iconborder"), o(this).find(".ult-dual-btn-1").find(".aio-icon").css({
                    "border-color": e
                }), o(this).find(".ult-dual-btn-1").find(".aio-icon-img").css({
                    background: t
                }), o(this).find(".ult-dual-btn-1").find(".aio-icon-img").css({
                ...
                var t, e = o(this).find(".ult-dual-btn-2").attr("class"),
                    i = e.split(" ");
                "Style1" == (e = i[1] + i[2]) && (t = o(this).find(".ult-dual-btn-2").data("bghovercolor"), o(this)[0].style.setProperty("background-color", t, "important")), "Style2" == e && (t = o(this).find(".ult-dual-btn-2").data("bghovercolor")), "Style3" == e && (t = o(this).find(".ult-dual-btn-2").data("bghovercolor"), o(this).css({
                    "box-shadow": " inset 0 0 20px 50px " + t
                })), "undefined" != e && (t = o(this).find(".ult-dual-btn-2").data("icon_hover_color"), o(this).find(".ult-dual-btn-2").find(".aio-icon").css({
                    color: t
                }), e = o(this).find(".ult-dual-btn-2").data("texthovercolor"), o(this).find(".ult-dual-btn-2").find(".ult-dual-button-title").css({
                    color: e
                }), t = o(this).find(".ult-dual-btn-2").data("iconbghovercolor"), o(this).find(".ult-dual-btn-2").find(".aio-icon").css({
                    background: t
                }), e = o(this).find(".ult-dual-btn-2").data("iconhoverborder"), o(this).find(".ult-dual-btn-2").find(".aio-icon").css({
                    "border-color": e
                ...
                var t, e = o(this).find(".ult-dual-btn-2").attr("class"),
                    i = e.split(" ");
                "Style1" == (e = i[1] + i[2]) && (t = o(this).find(".ult-dual-btn-2").data("bgcolor"), o(this)[0].style.setProperty("background-color", t, "important")), "Style2" == e && (t = o(this).find(".ult-dual-btn-2").data("bgcolor")), "Style3" == e && (t = o(this).find(".ult-dual-btn-2").data("bghovercolor"), o(this).css({
                    "box-shadow": " inset 0 0 0 0 " + t
                })), "undefined" != e && (t = o(this).find(".ult-dual-btn-2").data("icon_color"), o(this).find(".ult-dual-btn-2").find(".aio-icon").css({
                    color: t
                }), e = o(this).find(".ult-dual-btn-2").data("textcolor"), o(this).find(".ult-dual-btn-2").find(".ult-dual-button-title").css({
                    color: e
                }), t = o(this).find(".ult-dual-btn-2").data("iconbgcolor"), o(this).find(".ult-dual-btn-2").find(".aio-icon").css({
                    background: t
                }), e = o(this).find(".ult-dual-btn-2").data("iconborder"), o(this).find(".ult-dual-btn-2").find(".aio-icon").css({
                    "border-color": e
                }), o(this).find(".ult-dual-btn-2").find(".aio-icon-img").css({
                    background: t
                }), o(this).find(".ult-dual-btn-2").find(".aio-icon-img").css({
        ...
        jQuery(".ult_main_dualbtn").each(function(t) {
            ...
            (i = parseInt(i)) < e ? (jQuery(this).find(".ult_dual2").css({
                height: e
            }), jQuery(this).find(".ult_dual1").css({
                height: e
            })) : (e < i || e == i) && (jQuery(this).find(".ult_dual1").css({
                height: i
            }), jQuery(this).find(".ult_dual2").css({
                height: i
            }))
        }), jQuery(document).on("ult-expandable", function(t, e) {
            jQuery(e).find(".ult_dual_button").each(function(t) {
    ...
    function(l, d) {
        ...
        function i(t, e) {
            ...
            function i() {
                0 == n.timer && (n.timer = setInterval(function() {
                    s(n.opts.direction)
                }, n.opts.interval), l(n.opts.controls.toggle).addClass("et-run").html(n.opts.controls.stopText))
            }

            function o() {
                clearInterval(n.timer), n.timer = 0, l(n.opts.controls.toggle).removeClass("et-run").html(n.opts.controls.playText)
            }

            function s(t) {
                var e, i, o, s;
                n.elem.is(":visible") && (i = "up" == t ? (s = ":first-child", e = "-=", "appendTo") : (s = ":last-child", e = "+=", "prependTo"), s = (o = n.targ.children(s)).outerHeight(), "function" == typeof n.opts.callbacks.before && n.opts.callbacks.before.call(n, n.targ, o), n.targ.stop(!0, !0).animate({
                    top: e + s + "px"
                }, n.opts.speed, n.opts.easing, function() {
                    o.hide()[i](n.targ).fadeIn(), n.targ.css("top", 0), r(!0), "function" == typeof n.opts.callbacks.after && n.opts.callbacks.after.call(n, n.targ, o)
                }))
            }
            ...
            function r(t) {
                var e, i, o, s;
                "auto" == n.opts.height && (0 < n.opts.visible ? (i = t, o = 0, s = "et-item-visible", n.targ.children().removeClass(s), n.targ.children(":lt(" + n.opts.visible + ")").each(function() {
                    o += l(this).outerHeight(), l(this).addClass(s)
                }), i ? n.elem.stop(!0, !0).animate({
                    height: o
                }, n.opts.speed) : n.elem.css("height", o)) : (e = 0, i = n.elem.css("display"), n.elem.css("display", "block"), n.targ.children().each(function() {
            ...
            return n.opts = l.extend({}, c, e), n.elem = l(t), n.targ = l(t).children(":first-child"), n.timer = 0, n.elem.children().css("margin", 0).children().css("margin", 0), n.elem.css({
                    position: "relative",
                ...
                function() {
                    var t, e;
                    void 0 !== d.hidden ? (t = "hidden", e = "visibilitychange") : void 0 !== d.msHidden ? (t = "msHidden", e = "msvisibilitychange") : void 0 !== d.webkitHidden && (t = "webkitHidden", e = "webkitvisibilitychange");
                    d.addEventListener(e, function() {
                        (d[t] ? o : i)()
                    }, !1)
                }(), n.opts.mousePause && n.elem.on("mouseenter", function() {
        ...
        jQuery(".ult_exp_content").hide(),
            ...
            /* TREETHEMES*/
            jQuery(".ult_exp_section").unbind('click').click(function() {
                ...
                jQuery(this).trigger("select"), jQuery(document).trigger("ult-expandable", jQuery(this).next(".ult_exp_content"))
            }),
            /* TREETHEMES*/
            ...
            jQuery(".ult_exp_section").select(function() {
                ...
                jQuery(this).css({
                    ...
                    "border-color": c
                }), i != o && jQuery(this).find(".ult_expheader").stop().css("opacity", "0.1").html(function(t, e) {
                    return e == o ? i : o
                }).animate({
                    opacity: 1
                }, 300), jQuery(this).hasClass("ult_active_section") ? (t !== e && (jQuery(this).find(".ult_ex_icon").removeClass(t), jQuery(this).find(".ult_ex_icon").fadeOut(100).switchClass(t, e, 1500, "easeInOutQuad").fadeIn(300)), s !== n && jQuery(this).find(".ult_exp_img").fadeOut(200).attr("src", n).fadeIn(500)) : (t !== e && (jQuery(this).find(".ult_ex_icon").removeClass(e), jQuery(this).find(".ult_ex_icon").fadeOut(100).switchClass(e, t, 1500, "easeInOutQuad").fadeIn(300)), s !== n && jQuery(this).find(".ult_exp_img").fadeOut(200).attr("src", s).fadeIn(500))
            })
    }), jQuery(document).ready(function() {
        function t() {
            jQuery(".ult_exp_section_layer").each(function(e, i) {
                ...
                if (0 != o) {
                    let t = "true";
                    var s, n;
                    s = 0 < jQuery(i).parents(".wpb_row").length ? jQuery(i).parents(".wpb_column") : 0 < jQuery(i).parents(".wpb_column").length ? jQuery(i).parents(".wpb_row") : jQuery(i).parent();
                    if ("full" == o && (s = jQuery("body"), t = "false"), "ex-full" == o && (s = jQuery("html"), t = "false"), !isNaN(o))
                        for (e = 1; e < o && "HTML" != s.prop("tagName"); e++) s = s.parent();
                    n = "false" == t ? s.outerWidth() : s.width();
                    var a = s.offset().left - jQuery(i).offset().left;
                    "false" == t ? jQuery(i).css({
                        width: n,
                        "margin-left": a
                    }) : jQuery(i).css({
                        width: n
        ...
        jQuery(".ult_exp_section").select(function() {
            var t, e = jQuery(this).data("height");
            0 != e && (t = jQuery(this).offset().top, e = parseInt(t) - e, jQuery("html, body").animate({
                scrollTop: e
            }, 1200))
        })
    });
var fixto = function(n, t, a) {
    var r = (s = {
        ...
        }, a.documentElement.currentStyle && (s.getAll = s._getAllCurrentStyle), s),
        o = (e.prototype = {
            replace: function() {
    ...
    function e(t) {
        this.element = t, this.replacer = a.createElement("div"), this.replacer.style.visibility = "hidden", this.hide(), t.parentNode.insertBefore(this.replacer, t)
    }
    ...
    i.prototype = {
        ...
        getCssValue: function(t, e) {
            ...
            for (o in this._vendors)
                if (i = this._prefixValue(this._vendors[o], e), this._valueSupported(n, i, s)) return this._vendor = this._vendors[o], i;
            return null
        }
    };
    var l, s = new i,
        d = s.getJsProperty("transform");
    var c, u = s.getCssValue("position", "sticky"),
        h = s.getCssValue("position", "fixed");

    function p(t, e, i) {
        this.child = t, this._$child = n(t), this.parent = e, this.options = {
    ...
    function f(t, e, i) {
        p.call(this, t, e, i), this._replacer = new o.MimicNode(t), this._ghostNode = this._replacer.replacer, this._saveStyles(), this._saveViewportHeight(), this._proxied_onscroll = this._bind(this._onscroll, this), this._proxied_onresize = this._bind(this._onresize, this), this.start()
    }
    ...
    "Microsoft Internet Explorer" === navigator.appName && (c = parseFloat(navigator.appVersion.split("MSIE")[1])), p.prototype = {
        _mindtop: function() {
            var t = 0;
            if (this._$mind)
                for (var e, i, o = 0, s = this._$mind.length; o < s; o++)(i = (e = this._$mind[o]).getBoundingClientRect()).height ? t += i.height : (i = r.getAll(e), t += e.offsetHeight + r.toFloat(i.marginTop) + r.toFloat(i.marginBottom));
            return t
        },
        stop: function() {
        ...
        _setOptions: function(t) {
            n.extend(this.options, t), this.options.mind && (this._$mind = n(this.options.mind)), this.options.zIndex && (this.child.style.zIndex = this.options.zIndex)
        },
        ...
        _destroy: function() {},
        refresh: function() {}
    }, f.prototype = new p, n.extend(f.prototype, {
        _bind: function(t, e) {
            return function() {
                return t.call(e)
            }
        ...
        _onscroll: function() {
            this._scrollTop = a.documentElement.scrollTop || a.body.scrollTop, this._parentBottom = this.parent.offsetHeight + this._fullOffset("offsetTop", this.parent), !1 !== this.options.mindBottomPadding && (this._parentBottom -= r.getFloat(this.parent, "paddingBottom")), !this.fixed && this._shouldFix() ? (this._fix(), this._adjust()) : this._scrollTop > this._parentBottom || this._scrollTop < this._fullOffset("offsetTop", this._ghostNode) - this.options.top - this._mindtop() ? this._unfix() : this._adjust()
        },
        _shouldFix: function() {
        ...
        _isViewportAvailable: function() {
            ...
            return this._viewportHeight > this.child.offsetHeight + r.toFloat(t.marginTop) + r.toFloat(t.marginBottom)
        },
        _adjust: function() {
            var t = 0,
                e = this._mindtop(),
                ...
                s = null;
            l && (s = this._getContext()) && (t = Math.abs(s.getBoundingClientRect().top)), i = this._parentBottom - this._scrollTop - (this.child.offsetHeight + r.toFloat(o.marginBottom) + e + this.options.top), this.child.style.top = (i = 0 < i ? 0 : i) + e + t + this.options.top - r.toFloat(o.marginTop) + "px"
        },
        ...
        _stop: function() {
            this._unfix(), n(t).unbind("scroll", this._proxied_onscroll), n(this._toresize).unbind("resize", this._proxied_onresize)
        },
        _start: function() {
            this._onscroll(), n(t).bind("scroll", this._proxied_onscroll), n(this._toresize).bind("resize", this._proxied_onresize)
        },
        _destroy: function() {
    ...
    }), m.prototype = new p, n.extend(m.prototype, {
        _start: function() {
            var t = r.getAll(this.child);
...
function(t) {
    function e() {
        ...
        $jh(".uvc-heading").each(function() {
            ...
            if (left_rtl = "left", right_rtl = "right", jQuery("body").hasClass("rtl") && (left_rtl = "right", right_rtl = "left"), "line_with_icon" == t) {
                ...
                s = o / 2;
                e = "selector" == a ? (i = $jh(this).find(".aio-icon").outerWidth(), $jh(this).find(".aio-icon").outerHeight()) : (i = $jh(this).find(".aio-icon-img").outerWidth(), $jh(this).find(".aio-icon-img").outerHeight());
                a = d - i / 2 + i + u;
                let t = s;
                e += 3, $jh(this).find(".uvc-heading-spacer").height(e), "center" == r ? ($jh(this).find(".aio-icon-img").css({
                    margin: "0 auto"
                }), c = "#" + l + " .uvc-heading-spacer.line_with_icon:before{" + right_rtl + ":" + a + "px;}#" + l + " .uvc-heading-spacer.line_with_icon:after{" + left_rtl + ":" + a + "px;}") : "left" == r ? ($jh(this).find(".aio-icon-img").css({
                    float: r
                }), c = (c = "") != o ? "#" + l + " .uvc-heading-spacer.line_with_icon:before{left:" + (i + u) + "px;right:auto;}#" + l + " .uvc-heading-spacer.line_with_icon:after{left:" + (t + i + u) + "px;right:auto;}" : "#" + l + " .uvc-heading-spacer.line_with_icon:before{right:" + (a - i - 2 * u) + "px;}#" + l + " .uvc-heading-spacer.line_with_icon:after{left:" + (a - u) + "px;}") : "right" == r && ($jh(this).find(".aio-icon-img").css({
                    float: r
                }), c = (c = "") != o ? "#" + l + " .uvc-heading-spacer.line_with_icon:before{right:" + (i + u) + "px;left:auto;}#" + l + " .uvc-heading-spacer.line_with_icon:after{right:" + (t + i + u) + "px;left:auto;}" : "#" + l + " .uvc-heading-spacer.line_with_icon:before{right:" + (a - u) + "px;}#" + l + " .uvc-heading-spacer.line_with_icon:after{left:" + (a - i - 2 * u) + "px;}");
                d = $jh(this).attr("data-hborder_style"), s = $jh(this).attr("data-hborder_color"), a = $jh(this).attr("data-hborder_height");
                "auto" == n && "center" == r && (t = Math.floor(t - i + u));
                var c = '<div class="dynamic_ultimate_heading_css"><style>#' + l + " .uvc-heading-spacer.line_with_icon:before, #" + l + " .uvc-heading-spacer.line_with_icon:after{width:" + t + "px;border-style:" + d + ";border-color:" + s + ";border-bottom-width:" + a + "px;}" + c + "</style></div>";
                $jh(this).prepend(c)
            } else "line_only" == t && ("right" == r || "left" == r ? $jh(this).find(".uvc-heading-spacer").find(".uvc-headings-line").css({
                float: r
    ...
    $jh = t.noConflict(), $jh(document).ready(function(t) {
        e(), $jh(window).resize(function(t) {
            e()
        })
    }), t(window).on("load", function(t) {
        e(), jQuery(".ult_exp_section").select(function() {
    ...
    function t() {
        c(".ultimate-call-to-action").each(function(i, o) {
            ...
            if (0 != s) {
                ...
                let t = "true";
                var n;
                n = 0 < c(o).parents(".wpb_row").length ? c(o).parents(".wpb_row") : 0 < c(o).parents(".wpb_column").length ? c(o).parents(".wpb_column") : c(o).parent();
                if ("full" == s && (n = c("body"), t = "false"), "ex-full" == s && (n = c("html"), t = "false"), !isNaN(s))
...
function(A, I, o) {
    ...
    function d() {
        var e, i = (o.body || o.documentElement).style;
        if ("string" == typeof i.transition) return 1;
        v = ["Moz", "Webkit", "Khtml", "O", "ms"], e = "transition".charAt(0).toUpperCase() + "transition".substr(1);
        for (let t = 0; t < v.length; t++)
            if ("string" == typeof i[v[t] + e]) return 1
    }
    var l = {
        animation: "fade",
        arrow: !0,
    ...
    r.prototype = {
        ...
        _responsive() {
            ...
            jQuery(".ult-responsive").each(function(t, e) {
                let i = jQuery(e),
                    ...
                    d = "",
                    c = "";
                jQuery(e).hasClass("ult-tooltipster-content"), void 0 === o && null == o || jQuery.each(jQuery.parseJSON(o), function(t, e) {
                    const o = t;
                    void 0 !== e && null != e && (e = e.split(";"), jQuery.each(e, function(t, e) {
                        if (void 0 !== e || null != e) {
                            var i = e.split(":");
        ...
        _show() {
            ...
            "shown" != t.Status && "appearing" != t.Status && (t.options.delay ? t.timerShow = setTimeout(function() {
                ("click" == t.options.trigger || "hover" == t.options.trigger && t.mouseIsOverProxy) && (t._showNow(), t._responsive())
            }, t.options.delay) : t._showNow()), t._responsive()
        },
        _showNow(t) {
            const l = this;
            l.options.functionBefore.call(l.$el, l.$el, function() {
                if (l.enabled && null !== l.Content) {
                    t && l.callbacks.show.push(t), l.callbacks.hide = [], clearTimeout(l.timerShow), l.timerShow = null, clearTimeout(l.timerHide), l.timerHide = null, l.options.onlyOne && A(".ult-tooltipstered").not(l.$el).each(function(t, e) {
                        const n = A(e),
                    ...
                    function e() {
                        l.Status = "shown", A.each(l.callbacks.show, function(t, e) {
                            e.call(l.$el)
                        }), l.callbacks.show = []
                    }
                    if ("hidden" !== l.Status) {
                        var i = 0;
                        "disappearing" === l.Status ? (l.Status = "appearing", d() ? (l.$tooltip.clearQueue().removeClass("ult-tooltipster-dying").addClass("ult-tooltipster-" + l.options.animation + "-show"), 0 < l.options.speed && l.$tooltip.delay(l.options.speed), l.$tooltip.queue(e)) : l.$tooltip.stop().fadeIn(e)) : "shown" === l.Status && e()
                    } else {
                        l.Status = "appearing";
                        i = l.options.speed;
                        let t = BaseStyle = "";
                        l.options.ultCustomTooltipStyle && (t = l.options.ultContentStyle || "", BaseStyle = l.options.ultBaseStyle || ""), l.bodyOverflowX = A("body").css("overflow-x"), A("body").css("overflow-x", "hidden");
                        var o = "ult-tooltipster-" + l.options.animation,
                            s = "-webkit-transition-duration: " + l.options.speed + "ms; -webkit-animation-duration: " + l.options.speed + "ms; -moz-transition-duration: " + l.options.speed + "ms; -moz-animation-duration: " + l.options.speed + "ms; -o-transition-duration: " + l.options.speed + "ms; -o-animation-duration: " + l.options.speed + "ms; -ms-transition-duration: " + l.options.speed + "ms; -ms-animation-duration: " + l.options.speed + "ms; transition-duration: " + l.options.speed + "ms; animation-duration: " + l.options.speed + "ms;",
                        ...
                        if (BaseStyle = BaseStyle + " " + n + " " + a + " " + r + " " + s, l.$tooltip = A('<div id="' + l.options.ult_adv_id + '" class="ult-tooltipster-base ' + l.options.theme + '" style="' + BaseStyle + '"><div class="ult-tooltipster-content ult-responsive" data-ultimate-target="' + l.options.ultimate_target + "\" data-responsive-json-new = '" + l.options.responsive_json_new + "' style=\"" + t + '"></div></div>'), d() && l.$tooltip.addClass(o), l._content_insert(), l.$tooltip.appendTo("body"), l.reposition(), l.options.functionReady.call(l.$el, l.$el, l.$tooltip), d() ? (l.$tooltip.addClass(o + "-show"), 0 < l.options.speed && l.$tooltip.delay(l.options.speed), l.$tooltip.queue(e)) : l.$tooltip.css("display", "none").fadeIn(l.options.speed, e), l._interval_set(), A(I).on("scroll." + l.namespace + " resize." + l.namespace, function() {
                                l.reposition()
                            }), l.options.autoClose)
                            if (A("body").off("." + l.namespace), "hover" == l.options.trigger)
                                if (c && setTimeout(function() {
                                    ...
                                    }, 0), l.options.interactive) {
                                    c && l.$tooltip.on("touchstart." + l.namespace, function(t) {
                                        t.stopPropagation()
                                    });
                                    let t = null;
                                ...
                                } else l.$elProxy.on("mouseleave." + l.namespace + "-autoClose", function() {
                                    l.hide()
                                });
                        else "click" == l.options.trigger && (setTimeout(function() {
                            A("body").on("click." + l.namespace + " touchstart." + l.namespace, function() {
                                l.hide()
                            })
                        }, 0), l.options.interactive && l.$tooltip.on("click." + l.namespace + " touchstart." + l.namespace, function(t) {
                            t.stopPropagation()
                        }))
                    }
                    0 < l.options.timer && (l.timerHide = setTimeout(function() {
        ...
        _interval_set() {
            ...
            i.checkInterval = setInterval(function() {
                if (0 === A("body").find(i.$el).length || 0 === A("body").find(i.$elProxy).length || "hidden" == i.Status || 0 === A("body").find(i.$tooltip).length) "shown" != i.Status && "appearing" != i.Status || i.hide(), i._interval_cancel();
                else if (i.options.positionTracker) {
                    let t = i._repositionInfo(i.$elProxy),
                        e = !1;
                    s(t.dimension, i.elProxyPosition.dimension) && ("fixed" === i.$elProxy.css("position") ? s(t.position, i.elProxyPosition.position) && (e = !0) : s(t.offset, i.elProxyPosition.offset) && (e = !0)), e || i.reposition()
                }
            }, 200)
        },
        _interval_cancel() {
        ...
        _update(t) {
            ...
            e._content_set(t), null !== e.Content ? "hidden" !== e.Status && (e._content_insert(), e.reposition(), e.options.updateAnimation && (d() ? (e.$tooltip.css({
                ...
                "hidden" != e.Status && (e.$tooltip.removeClass("ult-tooltipster-content-changing"), setTimeout(function() {
        ...
        hide(t) {
            const i = this;
            t && i.callbacks.hide.push(t), i.callbacks.show = [], clearTimeout(i.timerShow), i.timerShow = null, clearTimeout(i.timerHide), i.timerHide = null;
            const e = function() {
                A.each(i.callbacks.hide, function(t, e) {
                    e.call(i.$el)
                }), i.callbacks.hide = []
            };
            return "shown" == i.Status || "appearing" == i.Status ? (i.Status = "disappearing", t = function() {
                i.Status = "hidden", "object" == typeof i.Content && null !== i.Content && i.Content.detach(), i.$tooltip.remove(), i.$tooltip = null, A(I).off("." + i.namespace), A("body").off("." + i.namespace).css("overflow-x", i.bodyOverflowX), A("body").off("." + i.namespace), i.$elProxy.off("." + i.namespace + "-autoClose"), i.options.functionAfter.call(i.$el, i.$el), e()
            }, d() ? (i.$tooltip.clearQueue().removeClass("ult-tooltipster-" + i.options.animation + "-show").addClass("ult-tooltipster-dying"), 0 < i.options.speed && i.$tooltip.delay(i.options.speed), i.$tooltip.queue(t)) : i.$tooltip.stop().fadeOut(i.options.speed, t)) : "hidden" == i.Status && e(), i
        },
        show(t) {
                ...
                if (m.$elProxy.is("area")) {
                    ...
                    if ("circle" == k) {
                        var y = parseInt($[0]),
                            b = parseInt($[1]),
                            g = parseInt($[2]);
                        a.dimension.height = 2 * g, a.dimension.width = 2 * g, a.offset.top = S + b - g, a.offset.left = T + y - g
                    } else if ("rect" == k) {
                        var y = parseInt($[0]),
                            b = parseInt($[1]),
                            _ = parseInt($[2]),
                            g = parseInt($[3]);
                        a.dimension.height = g - b, a.dimension.width = _ - y, a.offset.top = S + b, a.offset.left = T + y
                    } else if ("poly" == k) {
                        let e = 0,
                            i = 0,
                            o = 0,
                        ...
                        for (let t = 0; t < $.length; t++) {
                            var v = parseInt($[t]);
                            n = "even" == n ? (v > o && (o = v, 0 === t && (e = o)), v < e && (e = v), "odd") : (v > s && (s = v, 1 == t && (i = s)), v < i && (i = v), "even")
                        }
                        a.dimension.height = s - i, a.dimension.width = o - e, a.offset.top = S + i, a.offset.left = T + e
                    } else a.dimension.height = x.outerHeight(!1), a.dimension.width = x.outerWidth(!1), a.offset.top = S, a.offset.left = T
                }
                let n = 0,
                    t = 0,
                    r = 0,
        ...
        destroy() {
            ...
            var t, e = i.$el.data("ult-tooltipster-ns");
            return 1 === e.length ? (t = "string" == typeof i.Content ? i.Content : A("<div></div>").append(i.Content).html(), i.$el.removeClass("ult-tooltipstered").attr("title", t).removeData(i.namespace).removeData("ult-tooltipster-ns").off("." + i.namespace)) : (e = A.grep(e, function(t, e) {
                return t !== i.namespace
            }), i.$el.data("ult-tooltipster-ns", e)), i
        },
        elementIcon() {
        ...
        if ("string" == typeof s[0]) {
            ...
            return this.each(function() {
                ...
                if (!e) throw new Error("You called Tooltipster's \"" + s[0] + '" method on an uninitialized element');
                if ("function" != typeof e[s[0]]) throw new Error('Unknown method .ult-tooltipster("' + s[0] + '")');
                var i = e[s[0]](s[1], s[2]);
                if (i !== e) return o = i, !1
            }), "#*$~&" !== o ? o : this
        }
        ...
        return this.each(function() {
            let t = !1,
                ...
                i = null;
            !e || n ? t = !0 : a && console.log('Tooltipster: one or more tooltips are already attached to this element: ignoring. Use the "multiple" option to attach more tooltips.'), t && (i = new r(this, s[0]), e = e || [], e.push(i.namespace), A(this).data("ult-tooltipster-ns", e), A(this).data(i.namespace, i)), o.push(i)
        }), n ? o : this
    };
...
function(m, t) {
    m(document).ready(function(f) {
        function o() {
            ...
            m('a[href="#"]').click(function(t) {
                ...
                f(".ult-hotspot-tooltip[data-link_style='tootip']", f(this)).each(function() {
                    var t, e;
                    e = 0 < m(this).find(".aio-icon-img").length ? (t = m(this).find(".aio-icon-img").outerHeight(!0), m(this).find(".aio-icon-img").outerWidth(!0)) : (t = jQuery(this).find(".aio-icon").outerHeight(!0), jQuery(this).find(".aio-icon").outerWidth(!0));
                    ...
                    var s = f(this).data("tooltipanimation"),
                        ...
                        c = (f(this).data("tooltip-offsety"), f(this).find(".hotspot-tooltip-content").html(c).text()),
                        u = f(this).data("mycust-id");
                    h = f(this).data("ultimate-target"), p = f(this).data("responsive-json-new"), p = JSON.stringify(p), "top" == a && (i = 0), "bottom" == a && (i = t), "left" == a && (i = -i, o = 0), "right" == a && (o = e, i = -i), /firefox/.test(navigator.userAgent.toLowerCase()) && (o = 0, i = 0), f(this).ulttooltipster({
                        content: c,
                        position: a,
                        offsetX: o,
                        offsetY: i,
        ...
        o(), setTimeout(function() {
            m(t).load(function() {
                0 < m(".ult_hotspot_container").length && ("show" === (m(".ult_hotspot_container").find(".ult-hotspot-tooltip").attr("data-status") || "hide") && m(".ult-tooltipstered").ulttooltipster("destroy"), o())
            })
        }, 700), m(document).ajaxComplete(function(t, e, i) {
            o()
        })
    })
}(jQuery, window),
function(p, e) {
    function o() {
        p(".ult-ih-list").each(function(t, a) {
            const r = p(a).attr("data-shape"),
                ...
                h = jQuery(e).width() || "";
            p(a).find("li").each(function() {
                var t, e, i, o, s, n;
                p(a).find(".ult-ih-item").addClass("ult-ih-" + r), t = a, e = h, i = l, o = d, s = c, n = u, "" != e && (768 <= e ? p(t).find(".ult-ih-item").hasClass("ult-ih-effect20") ? p(t).find(".spinner").css({
                    height: parseInt(i),
                    width: parseInt(o)
                }) : p(t).find(".ult-ih-item, .ult-ih-img, .ult-ih-image-block, .ult-ih-list-item").css({
                    height: i,
                    width: o
                }) : p(t).find(".ult-ih-item").hasClass("ult-ih-effect20") ? p(t).find(".spinner").css({
                    height: parseInt(s),
                    width: parseInt(n)
                }) : p(t).find(".ult-ih-item, .ult-ih-img, .ult-ih-image-block, .ult-ih-list-item").css({
                    height: s,
    ...
    p(e).on("load", function() {
        ...
        o(), p(document).ajaxComplete(function(t, e, i) {
            o()
        })
    }), p(e).resize(function() {
        o()
...
function(s) {
    s(document).ready(function() {
        ...
        s(".ult-easy-separator-wrapper").each(function(t, e) {
            ...
            o.hasClass("upb-background-text") && (o = o.parents("." + i + ":first")), s(this).appendTo(o).find(".ult-no-animation").css({
                opacity: "1"
            })
        })
    })
        ...
        t(), o(window).resize(function() {
            ...
            if (jQuery(this).attr("data-animation")) {
                ...
                jQuery(this).bsf_appear(function() {
                    const t = jQuery(this);
                    t.addClass("animated").addClass(e), t.addClass("animated").addClass(i), t.css("opacity", "1")
                }, {
                    accY: -70
                })
            }
...
}(jQuery), jQuery(window).on("load", function(t) {
    info_box_set_auto_height()
}), jQuery(document).ready(function(t) {
    info_box_set_auto_height(), jQuery(window).resize(function(t) {
        info_box_set_auto_height()
    })
});
let resizedd = 0;
...
function calculate_clipped_circle() {
    jQuery(".clipped-info-circle").each(function() {
        ...
        "on" == i && (o = jQuery(this).children().data("responsive-breakpoint"), s = jQuery(window).width(), t = jQuery(this).data("circle-type"), o < s && (void 0 !== (m = jQuery(this).data("first-height")) && "" != m && jQuery(this).height(m), jQuery(this).width("100%"), make_info_circle(".info-c-full-br", resizedd)));
        var o, s, n = jQuery(this).find(".info-circle-icons").outerHeight(),
        ...
        if ("full-circle" != t) {
            ...
            var l, d, c, u, h = jQuery(this).css("margin-bottom"),
                p = jQuery(this).children().outerWidth(),
                f = parseInt(jQuery(this).find(".info-c-full").css("margin-top").replace(/[^-\d\.]/g, "")),
                m = parseInt(jQuery(this).find(".info-c-full").css("padding-top").replace(/[^-\d\.]/g, ""));
            "top-circle" == t || "bottom-circle" == t ? (jQuery(this).css({
                overflow: "hidden"
            }), jQuery(this).find(".info-c-full").outerWidth(), jQuery(this).find(".info-c-full").width(), "top-circle" == t ? (l = e / 100 * r, jQuery(this).css({
                "padding-top": y,
                height: l,
                "margin-bottom": 0
            }), d = l - f - parseInt(y.replace(/[^-\d\.]/g, "")) - m - m / 2, jQuery(this).find(".info-c-full-wrap").css({
                height: d
            })) : "bottom-circle" == t && (l = r - (r = (100 - e) / 100 * r) + 10, jQuery(this).css({
                "padding-bottom": h,
                height: l,
                "margin-top": 0
            }), jQuery(this).children().css({
                "margin-top": -(r + n / 2)
            }), d = l - f - parseInt(y.replace(/[^-\d\.]/g, "")) - m - m / 2)) : "left-circle" != t && "right-circle" != t || (jQuery(this).css({
                overflow: "hidden",
                "padding-top": y,
                "padding-bottom": h
            }), jQuery(this).find(".info-c-full").outerWidth(), jQuery(this).find(".info-c-full").width(), "left-circle" == t ? (c = e / 100 * p, jQuery(this).css({
                width: c,
                "padding-left": y
            }), jQuery(this).children().css({
                width: p,
                "max-width": p
            }), u = c - f - (m + m / 2) - parseInt(y.replace(/[^-\d\.]/g, "")), jQuery(this).find(".info-c-full-wrap").width(u)) : "right-circle" == t && (e = (100 - e) / 100 * p, c = parseInt(p - e), jQuery(this).css({
                width: c,
                "padding-right": y
            }), jQuery(this).children().css({
                "margin-left": -(e + a / 2),
                "max-width": p,
                width: p
            }), e = (e = e - f) + parseInt(y.replace(/[^-\d\.]/g, "")) - m, u = c - f - parseInt(y.replace(/[^-\d\.]/g, "")) - m, e = e, jQuery(this).find(".info-c-full-wrap").width(u), jQuery(this).find(".info-c-full-wrap").css({
                "margin-left": e + "px"
            })))
        }
        "on" == i && (o = jQuery(this).children().data("responsive-breakpoint"), (s = jQuery(window).width()) <= o && jQuery(this).css({
            width: "auto",
            overflow: "visible",
            height: "auto",
            padding: 0
...
function show_next_info_circle(t) {
    ...
    "" != e && (t.parents(".info-c-full-br").find("." + e).removeClass(e).removeClass("info-circle-active"), t.addClass(e).addClass("info-circle-active"));
    let i = t.next();
    const o = t.parents(".info-c-full-br").data("icon-show-size");
    "not-show" == t.parents(".info-c-full-br").data("icon-show") && (i.find("i.info-circle-icon").remove(), i.find("img.info-circle-img-icon").remove(), t.parents(".info-c-full-br").find(".info-c-full").addClass("circle-noicon")), i = i.html();
    t.css("font-size"), t.attr("style");
    const s = t.parents(".info-c-full-br");
    s.find(".info-c-full-wrap").stop().animate({
        opacity: 0
    }, "slow", function() {
        t.parents(".info-c-full-br").find(".info-c-full .info-c-full-wrap").html(i), s.find(".info-c-full i").css({
    ...
    jQuery(t).each(function() {
        if ("on" == jQuery(this).data("responsive-circle")) {
            ...
            var t = "info-circle-wrapper-" + e.data("uniqid"),
                t = "<style>@media(max-width:" + jQuery(this).data("responsive-breakpoint") + "px){ #" + t + " .smile_icon_list_wrap{ display: block; margin-top: auto !important; } #" + t + " .info-c-full-br{ display: none; } .smile_icon_list_wrap { margin-left:auto !important; max-width:inherit !important; width:auto !important; } .info-circle-responsive .info-circle-def { display: block; width: auto; height: auto; } .info-circle-responsive .info-circle-sub-def { display: block; vertical-align: top; } }</style>";
            ...
            jQuery(this).find(".icon-circle-list .info-details").each(function() {
                ...
                l.find(".icon_list_icon").html(a.wrap("<div />").parent().html()), l.find(".icon_description").css("color", c), l.find(".icon_description").css("background-color", d), l.find(".icon_description h3").html(e), l.find(".icon_description p").html(i), l.find(".icon_list_icon").css({
                    "background-color": o,
                    color: s,
                    border: n
                }), l.addClass(t), r.append(l.wrap("<div />").parent().html())
            })
        }
    })
}
...
function make_info_circle(t, e) {
    jQuery(t).each(function(t, r) {
        ...
        jQuery(jQuery(r).find(".icon-circle-list .info-circle-icons")).each(function(t, e) {
            ...
            n = e ? (o = s = a = l) / 2 : null != i ? (o = s = a = l) / 2 + i : (o = s = a = 2 * l, l), jQuery(r).parent().css({
                "margin-top": n + 10 + "px",
    ...
    }), ".info-c-full-br" == t && jQuery(t).each(function() {
        jQuery(this).css("height", jQuery(this).width()), jQuery(this).css("opacity", "1")
    }), ".info-c-semi-br" == t && jQuery(t).each(function() {
        ...
        e == resizedd && (".info-c-full-br" == t && part_circle_icon(t), ".info-c-semi-br" == t && semi_circle_icon(t))
    }, 1e3)
}
    ...
    jQuery(t).each(function() {
        jQuery(this).bsf_appear(function() {
            if ("none" != jQuery(this).css("display")) {
                ...
                for (h = 1; h <= c; h++) {
                    let t = h * ((180 + 2 * o) / c);
                    "full" == n ? (t < i && 1 == h ? (a = i - t, r = !1) : t > i && 1 == h && (a = t - i, r = !0), 1 == r ? t -= a : t += a) : t = t + s - o + u, t *= .0174532925, f.push(e * Math.cos(t)), f.push(e * Math.sin(t))
                }
                var h = 0,
                    p = 0;
                ...
                l = l || 1, d = d || .15, "" != m ? (p = -1e3 * d, jQuery(this).find(".icon-circle-list .info-circle-icons").each(function() {
                    const t = jQuery(this);
                    p += 1e3 * d, setTimeout(function() {
                        t.animate({
                            opacity: 1,
                            left: f[h++],
                            top: f[h++]
...
function setmytime(t, e) {
    ...
    if ("" != t && void 0 !== t && (i = t), "" != i) {
        ...
        if (0 < h.parents(".ult_tabs").length) {
            ...
            "" == u && (u = p.find("li.ult_tab_li").data("iconhover")), p.find("li.ult_tab_li").removeClass("current"), h.hasClass("ult_a") && h.parent().addClass("current"), "style1" == r || "style2" == r ? (p.find("a.ult_a").css({
                "background-color": s
            }), h.css({
                "background-color": o
            ...
            p.find(".ult_tabcontent").css({
                ...
                display: "block"
            }), jQuery(document).trigger("ultAdvancedTabClickedDualBtn", p.find(".ult_tabitemname:nth-child(" + u + ")"));
            p.offset().top, p.offset().left;
            p.addClass("ult_aniamte"), p.find("ul.ult_tabmenu li a.ult_a").click(function(t) {
    ...
    jQuery(".ult_tabs").each(function() {
        ...
        let e = 0;
        "on" == t && jQuery(this).find(".ult_tabitemname").each(function() {
        ...
        ! function() {
            ...
            jQuery(".ult_tabs").each(function() {
                ...
                s >= e ? (jQuery(this).parent().find("." + o).css({
                    display: "none"
                }), jQuery(this).parent().find("#" + o).css({
                    display: "block"
                }), "Both" != i && (jQuery(this).find(".aio-icon").hasClass("ult_tab_resp_icon") && jQuery(this).find(".aio-icon").removeClass("ult_tab_resp_icon").addClass("icon-top"), jQuery(this).find(".ult_tab_main").hasClass("ult_tab_resp_ult_top") && jQuery(this).find(".ult_tab_main").removeClass("ult_tab_resp_ult_top").addClass("ult_top"))) : ("Accordion" == t && (jQuery(this).parent().find("." + o).css({
                    display: "block"
                }), jQuery(this).parent().find("#" + o).css({
                    display: "none"
                })), "Both" != i && (jQuery(this).find(".aio-icon").hasClass("icon-top") && jQuery(this).find(".aio-icon").removeClass("icon-top").addClass("ult_tab_resp_icon"), jQuery(this).find(".ult_tab_main").hasClass("ult_top") && jQuery(this).find(".ult_tab_main").removeClass("ult_top").addClass("ult_tab_resp_ult_top"))), 300 < s && s < 660 && (jQuery(this).find(".ult_a ").removeClass("false"), d.push(ht1), "Both" != i && (jQuery(this).find(".aio-icon").hasClass("icon-top") && jQuery(this).find(".aio-icon").removeClass("icon-top").addClass("ult_tab_resp_icon"), jQuery(this).find(".ult_tab_main").hasClass("ult_top") && jQuery(this).find(".ult_tab_main").removeClass("ult_top").addClass("ult_tab_resp_ult_top")))
            })
        }()
    })
}
jQuery(document).ready(function() {
        make_info_circle(".info-c-full-br", 0), responsive_check(".info-c-full-br"), jQuery(".clipped-info-circle").each(function(t, e) {
            ...
            "click" == jQuery(this).data("focus-on") && jQuery(this).find(".icon-circle-list .info-circle-icons").click(function() {
                var t = jQuery(this);
                jQuery(this).parents(".info-c-full-br").attr("data-slide-true", "false"), show_next_info_circle(t)
            ...
            jQuery(".info-c-full-br").each(function() {
                ...
                t = t || .2, jQuery(this).attr("data-slide-number", "1"),
        ...
        o.fn.bsf_appear = function(e, t) {
            ...
            return this.each(function() {
                ...
                if (u.bsf_appeared = !1, e) {
                        ...
                        i = function() {
                            if (u.is(":visible")) {
                                var t = h.scrollLeft(),
                                    ...
                                    d = u.width(),
                                    c = h.width();
                                i <= s + r + a && s <= i + l + a && t <= o + d + n && o <= t + c + n ? u.bsf_appeared || u.trigger("bsf_appear", p.data) : u.bsf_appeared = !1
                    ...
                    p.one ? u.one("bsf_appear", p.data, t) : u.bind("bsf_appear", p.data, t), h.scroll(i), o.fn.bsf_appear.checks.push(i), i()
            ...
            checkAll: function() {
                ...
                if (0 < t)
                    for (; t--;)
                        ...
                        /* TREETHEMES*/
                        if (typeof o.fn.bsf_appear.checks[t] == "function") /* END TREETHEMES */

                            o.fn.bsf_appear.checks[t]()
            },
            run() {
                o.fn.bsf_appear.timeout && clearTimeout(o.fn.bsf_appear.timeout), o.fn.bsf_appear.timeout = setTimeout(o.fn.bsf_appear.checkAll, 20)
            }
        }), o.each(["append", "prepend", "after", "before", "attr", "removeAttr", "addClass", "removeClass", "toggleClass", "remove", "css", "show", "hide"], function(t, e) {
            const i = o.fn[e];
            i && (o.fn[e] = function() {
    ...
    function() {
        let A, I;
        A = this.jQuery || window.jQuery, I = A(window), A.fn.stick_in_parent = function(t) {
            let Q, e, k, i, o, C, s, x, T, n, S, $;
            for (null == t && (t = {}), $ = t.sticky_class, C = t.inner_scrolling, S = t.recalc_every, n = t.parent, T = t.offset_top, x = t.spacer, k = t.bottoming, null == T && (T = 0), null == n && (n = void 0), null == C && (C = !0), null == $ && ($ = "is_stuck"), Q = A(document), null == k && (k = !0), i = function(a, r, l, d, c, u, h, p) {
                    let f, t, m, y, b, g, _, v, e, w, j, o;
                    if (!a.data("sticky_kit")) {
                        if (a.data("sticky_kit", !0), b = Q.height(), _ = a.parent(), null != n && (_ = _.closest(n)), !_.length) throw "failed to find stick parent";
                        if (m = !1, f = !1, j = null != x ? x && a.closest(x) : A("<div />"), j && j.css("position", a.css("position")), v = function() {
                                let t, e, i;
                                if (!p) return b = Q.height(), t = parseInt(_.css("border-top-width"), 10), e = parseInt(_.css("padding-top"), 10), r = parseInt(_.css("padding-bottom"), 10), l = _.offset().top + t + e, d = _.height(), m && (m = !1, f = !1, null == x && (a.insertAfter(j), j.detach()), a.css({
                                    position: "",
                                    top: "",
                                    width: "",
                                    bottom: ""
                                }).removeClass($), i = !0), c = a.offset().top - (parseInt(a.css("margin-top"), 10) || 0) - T, u = a.outerHeight(!0), h = a.css("float"), j && j.css({
                            ...
                            }, v(), u !== d) return y = void 0, g = T, w = S, o = function() {
                            let t, e, i, o, s, n;
                            if (!p) return i = !1, null != w && (--w, w <= 0 && (w = S, v(), i = !0)), i || Q.height() === b || (v(), i = !0), o = I.scrollTop(), null != y && (e = o - y), y = o, m ? (k && (s = o + u + g > d + l, f && !s && (f = !1, a.css({
                                position: "fixed",
                                bottom: "",
                                top: g
                            }).trigger("sticky_kit:unbottom"))), o < c && (m = !1, g = T, null == x && ("left" !== h && "right" !== h || a.insertAfter(j), j.detach()), t = {
                                position: "",
                                width: "",
                                top: ""
                            }, a.css(t).removeClass($).trigger("sticky_kit:unstick")), C && (n = I.height(), u + T > n && (f || (g -= e, g = Math.max(n - u, g), g = Math.min(T, g), m && a.css({
                                top: g + "px"
                            }))))) : c < o && (m = !0, t = {
                                position: "fixed",
                                top: g
                            }, t.width = "border-box" === a.css("box-sizing") ? a.outerWidth() + "px" : a.width() + "px", a.css(t).addClass($), null == x && (a.after(j), "left" !== h && "right" !== h || j.append(a)), a.trigger("sticky_kit:stick")), m && k && (null == s && (s = o + u + g > d + l), !f && s) ? (f = !0, "static" === _.css("position") && _.css({
                                position: "relative"
                            }), a.css({
                                position: "absolute",
                                bottom: r,
                            ...
                            if (p = !0, I.off("touchmove", o), I.off("scroll", o), I.off("resize", e), A(document.body).off("sticky_kit:recalc", e), a.off("sticky_kit:detach", t), a.removeData("sticky_kit"), a.css({
                                    position: "",
                                    bottom: "",
                                    top: "",
                                    width: ""
                                }), _.position("position", ""), m) return null == x && ("left" !== h && "right" !== h || a.insertAfter(j), j.remove()), a.removeClass($)
                        }, I.on("touchmove", o), I.on("scroll", o), I.on("resize", e), A(document.body).on("sticky_kit:recalc", e), a.on("sticky_kit:detach", t), setTimeout(o, 0)
                    }
                }, o = 0, s = this.length; o < s; o++) e = this[o], i(A(e));
            return this
        }
    }.call(this), jQuery(document).ready(function(_) {
        const n = function(t, e) {
            ...
            v = function(t, e, i) {
                ...
                var o = Math.round(256 * e) * (i ? -1 : 1),
                    s = t.match(new RegExp("^rgba?\\(\\s*(\\d|[1-9]\\d|1\\d{2}|2[0-4][0-9]|25[0-5])\\s*,\\s*(\\d|[1-9]\\d|1\\d{2}|2[0-4][0-9]|25[0-5])\\s*,\\s*(\\d|[1-9]\\d|1\\d{2}|2[0-4][0-9]|25[0-5])(?:\\s*,\\s*(0|1|0?\\.\\d+))?\\s*\\)$", "i")),
                    e = s && null != s[4] ? s[4] : null,
                    t = s ? [s[1], s[2], s[3]] : t.replace(/^#?([a-f0-9][a-f0-9])([a-f0-9][a-f0-9])([a-f0-9][a-f0-9])/i, function() {
                        return parseInt(arguments[1], 16) + "," + parseInt(arguments[2], 16) + "," + parseInt(arguments[3], 16)
                    }).split(/,/);
                return s ? "rgb" + (null !== e ? "a" : "") + "(" + Math[i ? "max" : "min"](parseInt(t[0], 10) + o, i ? 0 : 255) + ", " + Math[i ? "max" : "min"](parseInt(t[1], 10) + o, i ? 0 : 255) + ", " + Math[i ? "max" : "min"](parseInt(t[2], 10) + o, i ? 0 : 255) + (null !== e ? ", " + e : "") + ")" : ["#", n(Math[i ? "max" : "min"](parseInt(t[0], 10) + o, i ? 0 : 255).toString(16), 2), n(Math[i ? "max" : "min"](parseInt(t[1], 10) + o, i ? 0 : 255).toString(16), 2), n(Math[i ? "max" : "min"](parseInt(t[2], 10) + o, i ? 0 : 255).toString(16), 2)].join("")
            },
            t = _(".ult-rs-wrapper");
        count = 0, t.each(function() {
            count += 1;
            let i = 0,
                o = 0,
                e = 0;
            ...
            a = a || "#3BF7D1";
            var s = a,
                r = (u = s, r = .2, v(u, r, !1), c = s, u = .2, v(c, u, !0));
            const l = r,
                d = r;
            ...
            if (r) {
                ...
                g.type = "text/css", g.innerHTML = ".ult-arrow" + count + ":before { " + r + " }.ult-arrow" + count + ":after { " + s + " }", document.getElementsByTagName("head")[0].appendChild(g);
            ...
            h = function(t, e) {
                ...
                var o = e.value || 1,
                    s = ".ult-title" + o,
                    e = ".ult-desc" + o;
                p.find(".ult-tooltip").hasClass("ult-done") || p.find(".ult-tooltip").each(function(t) {
                        _(this).addClass("ult-done"), i.append(_(this))
                    }), p.find(s).css("visibility", "visible"), p.find(s).siblings().css("visibility", "hidden"), f.find(e).css("display", "block"), f.find(e).siblings().css("display", "none"),
                    function(t) {
                        const e = ".ult-slider-ticks" + t,
                            i = p.find(e);
                        i.prevAll(".ui-slider-label-ticks").css("background", l), i.nextAll(".ui-slider-label-ticks").css("background", a)
                    }(o)
            };
            m.slider({
                range: "min",
                ...
                max: t - 1,
                tickInterval: 1
            }), "auto" == c && (n.find(".ult-tooltip").each(function() {
                var t = _(this).outerWidth(),
                    e = _(this).outerHeight(),
                    t = t / 2 + 10;
                i = i > t ? i : t, o = o > e ? o : e
            }), c = o + "px " + i + "px 35px", n.css("padding", c)), "on" == u && (f.find(".ult-description").each(function() {
                var t = _(this).outerHeight();
                e = e > t ? e : t
            }), e = e + 30 + "px", f.find(".ult-desc-wrap").css("min-height", e)), n.find(".ui-slider-labels").children(".ui-slider-label-ticks").css("background", a);
            const y = {};
            y.background = d;
    ...
    function(s) {
        s(document).ready(function() {
            s(".ult-carousel-wrapper").each(function() {
                const t = s(this);
                var e, i, o;
                t.hasClass("ult_full_width") && (t.css("left", 0), t.css("right", 0), e = t.attr("data-rtl"), i = s("html").outerWidth(), o = t.offset().left, o = Math.abs(0 - o), "true" === e || !0 === e ? t.css({
                    position: "relative",
                    right: "-" + o + "px",
                    width: i + "px"
                }) : t.css({
                ...
                var i = s(e).data("gutter"),
                    e = s(e).attr("id");
                "" != i && (i = "<style>#" + e + " .slick-slide { margin:0 " + i + "px; } </style>", s("head").append(i))
            }), s(".ult-carousel-wrapper").on("init", function(t) {
                t.preventDefault(), s(".ult-carousel-wrapper .ult-item-wrap.slick-active").each(function(t, e) {
                    $this = s(this), $this.addClass($this.data("animation"))
                })
            }), s(".ult-carousel-wrapper").on("beforeChange", function(t, e, i) {
                $inViewPort = s("[data-slick-index='" + i + "']"), $inViewPort.siblings().removeClass($inViewPort.data("animation"))
            }), s(".ult-carousel-wrapper").on("afterChange", function(t, e, i, o) {
                if (slidesScrolled = e.options.slidesToScroll, slidesToShow = e.options.slidesToShow, centerMode = e.options.centerMode, windowWidth = jQuery(window).width(), windowWidth < 1025 && (slidesToShow = e.options.responsive[0].settings.slidesToShow), windowWidth < 769 && (slidesToShow = e.options.responsive[1].settings.slidesToShow), windowWidth < 481 && (slidesToShow = e.options.responsive[2].settings.slidesToShow), $currentParent = e.$slider[0].parentElement.id, slideToAnimate = i + slidesToShow - 1, 1 == slidesScrolled) $inViewPort = 1 == centerMode ? (animate = slideToAnimate - 2, s("#" + $currentParent + " [data-slick-index='" + animate + "']")) : s("#" + $currentParent + " [data-slick-index='" + slideToAnimate + "']"), $inViewPort.addClass($inViewPort.data("animation"));
                else
                    for (let t = slidesScrolled + i; 0 <= t; t--) $inViewPort = s("#" + $currentParent + " [data-slick-index='" + t + "']"), $inViewPort.addClass($inViewPort.data("animation"))
            }), s(window).resize(function() {
                s(".ult-carousel-wrapper").each(function() {
                    const t = s(this);
                    var e, i, o;
                    t.hasClass("ult_full_width") && (e = t.attr("data-rtl"), t.removeAttr("style"), i = s("html").outerWidth(), o = t.offset().left, o = Math.abs(0 - o), "true" === e || !0 === e ? t.css({
                        position: "relative",
                        right: "-" + o + "px",
                        width: i + "px"
                    }) : t.css({
            ...
            s(".ult-carousel-wrapper").each(function() {
                const t = s(this);
                var e, i, o;
                t.hasClass("ult_full_width") && (t.css("left", 0), t.css("right", 0), i = t.offset().left, o = Math.abs(0 - i), e = t.attr("data-rtl"), i = s("html").outerWidth(), o = o, "true" === e || !0 === e ? t.css({
                    position: "relative",
                    right: "-" + o + "px",
                    width: i + "px"
                }) : t.css({
            ...
            s(e).find(".ult-carousel-wrapper").each(function() {
                const t = s(this);
                var e, i, o;
                t.hasClass("ult_full_width") && (t.css("left", 0), t.css("right", 0), i = t.offset().left, o = Math.abs(0 - i), e = t.attr("data-rtl"), i = s("html").outerWidth(), o = o, "true" === e || !0 === e ? t.css({
                    position: "relative",
    ...
    function(t) {
        ...
        a = (o = 0, function(t, e) {
            ...
            if ("window" === n.respondTo ? s = l : "slider" === n.respondTo ? s = r : "min" === n.respondTo && (s = Math.min(l, r)), n.options.responsive && n.options.responsive.length && null !== n.options.responsive) {
                ...
                null !== o ? null !== n.activeBreakpoint && o === n.activeBreakpoint && !e || (n.activeBreakpoint = o, "unslick" === n.breakpointSettings[o] ? n.unslick(o) : (n.options = d.extend({}, n.originalSettings, n.breakpointSettings[o]), !0 === t && (n.currentSlide = n.options.initialSlide), n.refresh(t)), a = o) : null !== n.activeBreakpoint && (n.activeBreakpoint = null, n.options = n.originalSettings, !0 === t && (n.currentSlide = n.options.initialSlide), n.refresh(t), a = o), t || !1 === a || n.$slider.trigger("breakpoint", [n, a])
            }
            ...
            let t;
            1 < this.options.rows && (t = this.$slides.children().children(), t.removeAttr("style"), this.$slider.empty().append(t))
            ...
            let e, i, o, s = this,
                n = 0;
            return s.slideOffset = 0, i = s.$slides.first().outerHeight(!0), !0 === s.options.infinite ? (s.slideCount > s.options.slidesToShow && (s.slideOffset = s.slideWidth * s.options.slidesToShow * -1, n = i * s.options.slidesToShow * -1), s.slideCount % s.options.slidesToScroll != 0 && t + s.options.slidesToScroll > s.slideCount && s.slideCount > s.options.slidesToShow && (n = t > s.slideCount ? (s.slideOffset = (s.options.slidesToShow - (t - s.slideCount)) * s.slideWidth * -1, (s.options.slidesToShow - (t - s.slideCount)) * i * -1) : (s.slideOffset = s.slideCount % s.options.slidesToScroll * s.slideWidth * -1, s.slideCount % s.options.slidesToScroll * i * -1))) : t + s.options.slidesToShow > s.slideCount && (s.slideOffset = (t + s.options.slidesToShow - s.slideCount) * s.slideWidth, n = (t + s.options.slidesToShow - s.slideCount) * i), s.slideCount <= s.options.slidesToShow && (s.slideOffset = 0, n = 0), !0 === s.options.centerMode && !0 === s.options.infinite ? s.slideOffset += s.slideWidth * Math.floor(s.options.slidesToShow / 2) - s.slideWidth : !0 === s.options.centerMode && (s.slideOffset = 0, s.slideOffset += s.slideWidth * Math.floor(s.options.slidesToShow / 2)), e = !1 === s.options.vertical ? t * s.slideWidth * -1 + s.slideOffset : t * i * -1 + n, !0 === s.options.variableWidth && (o = s.slideCount <= s.options.slidesToShow || !1 === s.options.infinite ? s.$slideTrack.children(".slick-slide").eq(t) : s.$slideTrack.children(".slick-slide").eq(t + s.options.slidesToShow), e = !0 === s.options.rtl ? o[0] ? -1 * (s.$slideTrack.width() - o[0].offsetLeft - o.width()) : 0 : o[0] ? -1 * o[0].offsetLeft : 0, !0 === s.options.centerMode && (o = s.slideCount <= s.options.slidesToShow || !1 === s.options.infinite ? s.$slideTrack.children(".slick-slide").eq(t) : s.$slideTrack.children(".slick-slide").eq(t + s.options.slidesToShow + 1), e = !0 === s.options.rtl ? o[0] ? -1 * (s.$slideTrack.width() - o[0].offsetLeft - o.width()) : 0 : o[0] ? -1 * o[0].offsetLeft : 0, e += (s.$list.width() - o.outerWidth()) / 2)), e
            ...
            let t, e = this,
                ...
                o = 0,
                s = [];
            for (t = !1 === e.options.infinite ? e.slideCount : (i = -1 * e.options.slidesToScroll, o = -1 * e.options.slidesToScroll, 2 * e.slideCount); t > i;) s.push(i), i = o + e.options.slidesToScroll, o += e.options.slidesToScroll <= e.options.slidesToShow ? e.options.slidesToScroll : e.options.slidesToShow;
            return s
        }, a.prototype.getSlick = function() {
            return this
        }, a.prototype.getSlideCount = function() {
            let i, o, s = this;
            return o = !0 === s.options.centerMode ? s.slideWidth * Math.floor(s.options.slidesToShow / 2) : 0, !0 === s.options.swipeToSlide ? (s.$slideTrack.find(".slick-slide").each(function(t, e) {
                return e.offsetLeft - o + d(e).outerWidth() / 2 > -1 * s.swipeLeft ? (i = e, !1) : void 0
            ...
            n.length ? (e = n.first(), i = e.attr("data-lazy"), o = document.createElement("img"), o.onload = function() {
            ...
            let t, e, i, o, s, n = this,
                a = !1;
            if ("object" === d.type(arguments[0]) ? (i = arguments[0], a = arguments[1], s = "multiple") : "string" === d.type(arguments[0]) && (i = arguments[0], o = arguments[1], a = arguments[2], "responsive" === arguments[0] && "array" === d.type(arguments[1]) ? s = "responsive" : void 0 !== arguments[1] && (s = "single")), "single" === s) n.options[i] = o;
            else if ("multiple" === s) d.each(i, function(t, e) {
                n.options[t] = e
            });
            ...
            let e, i, o, s, n = this;
            i = n.$slider.find(".slick-slide").removeClass("slick-active slick-center slick-current").attr("aria-hidden", "true"), n.$slides.eq(t).addClass("slick-current"), !0 === n.options.centerMode ? (e = Math.floor(n.options.slidesToShow / 2), !0 === n.options.infinite && (e <= t && t <= n.slideCount - 1 - e ? n.$slides.slice(t - e, t + e + 1).addClass("slick-active").attr("aria-hidden", "false") : (o = n.options.slidesToShow + t, i.slice(o - e + 1, o + e + 2).addClass("slick-active").attr("aria-hidden", "false")), 0 === t ? i.eq(i.length - 1 - n.options.slidesToShow).addClass("slick-center") : t === n.slideCount - 1 && i.eq(n.options.slidesToShow).addClass("slick-center")), n.$slides.eq(t).addClass("slick-center")) : 0 <= t && t <= n.slideCount - n.options.slidesToShow ? n.$slides.slice(t, t + n.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false") : i.length <= n.options.slidesToShow ? i.addClass("slick-active").attr("aria-hidden", "false") : (s = n.slideCount % n.options.slidesToShow, o = !0 === n.options.infinite ? n.options.slidesToShow + t : t, (n.options.slidesToShow == n.options.slidesToScroll && n.slideCount - t < n.options.slidesToShow ? i.slice(o - (n.options.slidesToShow - s), o + s) : i.slice(o, o + n.options.slidesToShow)).addClass("slick-active").attr("aria-hidden", "false")), "ondemand" === n.options.lazyLoad && n.lazyLoad()
        }, a.prototype.setupInfinite = function() {
            let t, e, i, o = this;
            if (!0 === o.options.fade && (o.options.centerMode = !1), !0 === o.options.infinite && !1 === o.options.fade && (e = null, o.slideCount > o.options.slidesToShow)) {
                for (i = !0 === o.options.centerMode ? o.options.slidesToShow + 1 : o.options.slidesToShow, t = o.slideCount; t > o.slideCount - i; --t) e = t - 1, d(o.$slides[e]).clone(!0).attr("id", "").attr("data-slick-index", e - o.slideCount).prependTo(o.$slideTrack).addClass("slick-cloned");
                for (t = 0; i > t; t += 1) e = t, d(o.$slides[e]).clone(!0).attr("id", "").attr("data-slick-index", e + o.slideCount).appendTo(o.$slideTrack).addClass("slick-cloned");
            ...
            let t, e, i, o, s = this;
            return t = s.touchObject.startX - s.touchObject.curX, e = s.touchObject.startY - s.touchObject.curY, i = Math.atan2(e, t), o = Math.round(180 * i / Math.PI), o < 0 && (o = 360 - Math.abs(o)), o <= 45 && 0 <= o || o <= 360 && 315 <= o ? !1 === s.options.rtl ? "left" : "right" : 135 <= o && o <= 225 ? !1 === s.options.rtl ? "right" : "left" : !0 === s.options.verticalSwiping ? 35 <= o && o <= 135 ? "down" : "up" : "vertical"
            ...
            let e, i, o, s, n, a = this;
            return n = void 0 !== t.originalEvent ? t.originalEvent.touches : null, !(!a.dragging || n && 1 !== n.length) && (e = a.getLeft(a.currentSlide), a.touchObject.curX = void 0 !== n ? n[0].pageX : t.clientX, a.touchObject.curY = void 0 !== n ? n[0].pageY : t.clientY, a.touchObject.swipeLength = Math.round(Math.sqrt(Math.pow(a.touchObject.curX - a.touchObject.startX, 2))), !0 === a.options.verticalSwiping && (a.touchObject.swipeLength = Math.round(Math.sqrt(Math.pow(a.touchObject.curY - a.touchObject.startY, 2)))), "vertical" !== (i = a.swipeDirection()) ? (void 0 !== t.originalEvent && 4 < a.touchObject.swipeLength && t.preventDefault(), s = (!1 === a.options.rtl ? 1 : -1) * (a.touchObject.curX > a.touchObject.startX ? 1 : -1), !0 === a.options.verticalSwiping && (s = a.touchObject.curY > a.touchObject.startY ? 1 : -1), o = a.touchObject.swipeLength, (a.touchObject.edgeHit = !1) === a.options.infinite && (0 === a.currentSlide && "right" === i || a.currentSlide >= a.getDotCount() && "left" === i) && (o = a.touchObject.swipeLength * a.options.edgeFriction, a.touchObject.edgeHit = !0), !1 === a.options.vertical ? a.swipeLeft = e + o * s : a.swipeLeft = e + o * (a.$list.height() / a.listWidth) * s, !0 === a.options.verticalSwiping && (a.swipeLeft = e + o * s), !0 !== a.options.fade && !1 !== a.options.touchMove && (!0 === a.animating ? (a.swipeLeft = null, !1) : void a.setCSS(a.swipeLeft))) : void 0)
            ...
            let t, e, i = this,
                ...
                n = i.length;
            for (t = 0; n > t; t++)
                if ("object" == typeof o || void 0 === o ? i[t].slick = new a(i[t], o) : e = i[t].slick[o].apply(i[t].slick, s), void 0 !== e) return e;
            return i
        }
        ...
        function t() {
            elements = _("div.ult-sticky-anchor"), elements.each(function() {
                const i = _(this),
                    o = i.find(".ult-sticky");
                var s = o.data("mobile");
                const t = i.find(".ult-space");
                if (v < 768 && "no" == s) return o.removeClass("ult-stick"), t.css("height", ""), void i.removeClass("ult-permanent-flag");
                let n = e.scrollTop(),
                    a = i.offset().top;
                var r = e.height(),
                ...
                if ("stick_with_scroll_row" != l && "yes" != d) {
                    ...
                    let e = -1;
                    u = j(0, u, h, p), "top" == d ? n = parseInt(n) + parseInt(u) : (n = parseInt(n) + parseInt(r) - parseInt(c) - parseInt(u), a = parseInt(a)), "fullwidth" == s ? t = "100%" : "customwidth" == s && (t = y);
                    const b = {};
                    b[d] = u, b.width = t, "stick_permanent" == l && (b[f] = m);
                    const g = {};
                    g[d] = "", g.width = "", "stick_permanent" != l || i.hasClass("ult-permanent-flag") || (i.addClass("ult-permanent-flag"), o.addClass("ult-stick").css(b)), "stick_with_scroll" == l && n > a ? (e = 0, i.hasClass("ult-flag") && 0 != w || (i.addClass("ult-flag"), e = (("fullwidth" == s ? o.addClass("ult-stick-full-width") : o.addClass("ult-stick")).css(b), i.find(".ult-space").css("height", c), 1))) : "stick_with_scroll" == l && i.hasClass("ult-flag") && (i.removeClass("ult-flag"), ("fullwidth" == s ? o.removeClass("ult-stick-full-width") : o.removeClass("ult-stick")).css(g), i.find(".ult-space").css("height", ""))
                }
            }), w = -1
        }
        ...
        function j(i, t, e, o) {
            var s;
            return e ? (s = e.split(" "), jQuery.each(s, function(t, e) {
                i = parseInt(i) + _(e).outerHeight()
            })) : e = "null", o ? (e = o.split(" "), jQuery.each(e, function(t, e) {
                i = parseInt(i) + _(e).outerHeight()
            })) : o = "null", t = t ? parseInt(t) + parseInt(i) : i
        }! function() {
            ...
            t.each(function() {
                ...
                if ("stick_with_scroll_row" == o || "no" != s) {
                    ...
                    e.parent().offset().top;
                    e.addClass("ult_stick_to_row"), t.addClass("ult_s_container"), "yes" == s && (t = "body"), v < 768 && "no" == o || e.fixTo(t, {
                        top: n,
                        useNativeSticky: !1
                    })
                }
    ...
    function(n, e) {
        ...
        jQuery.fn.reverse = [].reverse, n.SwatchBook = function(t, e) {
            ...
            _openItem(t) {
                var e = t.index();
                e !== this.current && (-1 !== this.options.closeIdx && e === this.options.closeIdx ? (this._openclose(), this._setCurrent()) : (this._setCurrent(t), t.css({
                    transform: "rotate(0deg)"
            ...
            _rotateSiblings(t) {
                let e = this,
                    ...
                    o = this.cache[i],
                    s;
                o ? s = o : (s = t.siblings(), this.cache[i] = s), s.each(function(t) {
                    t = "rotate(" + (t < i ? e.options.angleInc * (t - i) : t - i == 1 ? e.options.proximity : e.options.proximity + (t - i - 1) * e.options.neighbor) + "deg)";
                    n(this).css({
                        transform: t
                    })
                })
            ...
            _setCurrent(t) {
                this.current = t ? t.index() : -1, this.$items.removeClass("ff-active"), t && t.addClass("ff-active")
            }
        };
        const o = function(t) {
        ...
        n.fn.swatchbook = function(t) {
            ...
            if ("string" == typeof t) {
                ...
                this.each(function() {
                    e ? n.isFunction(e[t]) && "_" !== t.charAt(0) ? e[t].apply(e, i) : o("no such method '" + t + "' for swatchbook instance") : o("cannot call methods on swatchbook prior to initialization; attempted to call method '" + t + "'")
                })
    ...
    }(jQuery, window), jQuery(document).ready(function(c) {
        function l(t) {
            ...
            if ("" !== t && void 0 !== t && (e = t), "" != e) {
                ...
                s.css("background-color", i), s.css("color", o), s.find(".aio-icon").css("color", t), jQuery(".ult_acord ").find("#" + e).parents("dt").next("dd").removeClass("ult-tabto-accolapsed")
            }
        }
        c(".cq-accordion").each(function() {
            c(this), c(this).find("li").each(function() {
                c(this).find("i").css("margin-top", .5 * (c(this).outerHeight() - 9))
            })
            ...
            "" == r && (r = c(this).find(".aio-icon").data("iconhover")), c(this).find(".ult-tabto-actitle").each(function() {
                const t = c(this).find(".aio-icon").data("iconcolor"),
                    e = c(this).find(".aio-icon").data("iconhover");
                c(this).css("background-color", i).on("mouseover", function() {
                    c(this).hasClass("ult-tabto-actitleActive") || (c(this).css({
                        "background-color": s,
                        color: n
                    ...
                    c(this).hasClass("ult-tabto-actitleActive") || c(this).css({
                        "background-color": i,
                        color: o
                    }), 1 == c(this).hasClass("ult-tabto-actitleActive") || c(this).find(".aio-icon").css({
                        color: t
                    })
                })
                ...
                e = c(t.target).is("i") ? c(t.target).parent() : c(t.target), e.hasClass("ult-tabto-actitle") ? (i = e.parent().next(), o = e.parents(".ult-tabto-accordion").data("animation"), i.nextAll("dd").hasClass("cq-animateIn") && i.nextAll("dd").removeClass("cq-animateIn").addClass(" cq-animateOut ult-tabto-accolapsed"), i.prevAll("dd").hasClass("cq-animateIn") && i.prevAll("dd").removeClass("cq-animateIn").addClass("ult-tabto-accolapsed"), i.nextAll("dd").hasClass("ult-ac-slidedown") && i.nextAll("dd").removeClass("ult-ac-slidedown").addClass(" ult-ac-slideup ult-tabto-accolapsed"), i.prevAll("dd").hasClass("ult-ac-slidedown") && i.prevAll("dd").removeClass("ult-ac-slidedown").addClass("ult-tabto-accolapsed"), i.prevAll("dt").find(".ult-tabto-actitle").hasClass("ult-tabto-actitleActive") && i.prevAll("dt").find(".ult-tabto-actitle").removeClass("ult-tabto-actitleActive").addClass("ult-acc-normal"), i.nextAll("dt").find(".ult-tabto-actitle").hasClass("ult-tabto-actitleActive") && i.nextAll("dt").find(".ult-tabto-actitle").removeClass("ult-tabto-actitleActive").addClass("ult-acc-normal"), e.removeClass("ult-acc-normal"), jQuery(this).find(".ult-acc-normal").each(function() {
                ...
                }), e.find(".aio-icon").data("iconcolor"), e.find(".aio-icon").data("iconhover"), e.css({
                    color: a,
                    "background-color": d
                }), e.find(".aio-icon").css({
                    color: r
                }), "Fade" == o ? (e.toggleClass("ult-tabto-actitleActive"), i.hasClass("ult-tabto-accolapsed") ? (i.hasClass("cq-animateOut") && i.removeClass("cq-animateOut"), i.addClass("cq-animateIn")) : (i.removeClass("cq-animateIn"), i.addClass("cq-animateOut"))) : (e.toggleClass("ult-tabto-actitleActive"), i.hasClass("ult-tabto-accolapsed") ? (i.hasClass("ult-ac-slideup") && i.removeClass("ult-ac-slideup"), i.addClass("ult-ac-slidedown")) : (i.removeClass("ult-ac-slidedown"), i.addClass("ult-ac-slideup"))), i.toggleClass("ult-tabto-accolapsed"), t.preventDefault(), i.hasClass("ult-tabto-accolapsed") && e.removeClass("ult-tabto-actitleActive")) : (e = c(t.target).is("i") ? c(t.target).parent().parent() : c(t.target), e.hasClass("ult-tabto-actitle") ? (i = e.parent().next(), o = e.parents(".ult-tabto-accordion").data("animation"), i.nextAll("dd").hasClass("cq-animateIn") && i.nextAll("dd").removeClass("cq-animateIn").addClass(" cq-animateOut ult-tabto-accolapsed"), i.prevAll("dd").hasClass("cq-animateIn") && i.prevAll("dd").removeClass("cq-animateIn").addClass("ult-tabto-accolapsed"), i.nextAll("dd").hasClass("ult-ac-slidedown") && i.nextAll("dd").removeClass("ult-ac-slidedown").addClass(" ult-ac-slideup ult-tabto-accolapsed"), i.prevAll("dd").hasClass("ult-ac-slidedown") && i.prevAll("dd").removeClass("ult-ac-slidedown").addClass("ult-tabto-accolapsed"), i.prevAll("dt").find(".ult-tabto-actitle").hasClass("ult-tabto-actitleActive") && i.prevAll("dt").find(".ult-tabto-actitle").removeClass("ult-tabto-actitleActive").addClass("ult-acc-normal"), i.nextAll("dt").find(".ult-tabto-actitle").hasClass("ult-tabto-actitleActive") && i.nextAll("dt").find(".ult-tabto-actitle").removeClass("ult-tabto-actitleActive").addClass("ult-acc-normal"), e.removeClass("ult-acc-normal"), jQuery(this).find(".ult-acc-normal").each(function() {
                    var t = jQuery(this).find(".aio-icon").data("iconcolor"),
                        e = (jQuery(this).find(".aio-icon").data("iconhover"), jQuery(this).parents(".ult-tabto-accordion").data("titlebg")),
                        i = jQuery(this).parents(".ult-tabto-accordion").data("titlecolor");
                    jQuery(this).css({
                    ...
                    color: r
                }), "Fade" == o ? (e.toggleClass("ult-tabto-actitleActive"), i.hasClass("ult-tabto-accolapsed") ? (i.hasClass("cq-animateOut") && i.removeClass("cq-animateOut"), i.addClass("cq-animateIn")) : (i.removeClass("cq-animateIn"), i.addClass("cq-animateOut"))) : (e.toggleClass("ult-tabto-actitleActive"), i.hasClass("ult-tabto-accolapsed") ? (i.hasClass("ult-ac-slideup") && i.removeClass("ult-ac-slideup"), i.addClass("ult-ac-slidedown")) : (i.removeClass("ult-ac-slidedown"), i.addClass("ult-ac-slideup"))), i.toggleClass("ult-tabto-accolapsed"), t.preventDefault(), i.hasClass("ult-tabto-accolapsed") && e.removeClass("ult-tabto-actitleActive"))))), "on" == l && jQuery("html, body").animate({
                    scrollTop: c(this).offset().top - 100
                }, 1200)
            })
        }), l(), jQuery(".ult-tabto-accordion").each(function() {
        ...
        }), jQuery(this).find("a").click(function(t) {
            const e = jQuery(this).attr("href");
            if (void 0 !== e && 0 < e.length) {
                ...
                void 0 !== o && "" !== o && (o = o.replace("#", "")), 0 < n.parents(".ult-tabto-accordion").length && s == o && !i && (n.parents(".ult-tabto-accordion").find(".ult-tabto-actitle").each(function(t, e) {
                    var i = jQuery(this).attr("id");
                    o !== i && (jQuery(this).parent().removeClass("current"), jQuery(this).removeClass("ult-tabto-actitleActive"), jQuery(this).css({
                        background: r,
                        color: a
                    }), i = jQuery(this).find(".aio-icon").data("iconcolor"), jQuery(this).find(".ult_tab_icon").css({
                        color: i
                    }), jQuery(this).parents("dt").next("dd").addClass("ult-tabto-accolapsed"))
                }), l(o))
            }
        }), jQuery(this).find("a.ult-tabto-actitle").click(function(t) {
        ...
        g(".ult_tabs").each(function() {
            function r() {
                clearTimeout(i), e - 1 < ++y && (y = 0), i = setTimeout(function() {
            ...
            var t = g(this),
                ...
                y = 0;
            const b = [];
            b.push(0), g(this).find("ul.ult_tabmenu").addClass("active").find("> li.ult_tab_li:eq(0)").addClass("current"), g(this).find("ul.ult_tabmenu li.ult_tab_li").each(function(t) {
                const e = g(this).data("iconhover"),
                    i = g(this).data("iconcolor");
                "" == p && (p = e), 0 == t && ("style2" == l || "style1" == l ? (g(this).find("a.ult_a").css({
                    background: f,
                    color: h
                    ...
                    g(this).hasClass("current") || (g(this).hasClass("current") || "style2" == l || "style1" == l ? (g(this).find("a.ult_a").css({
                        background: s,
                        color: o
                    }), g(this).find(".ult_tab_icon").css({
                        color: e
                    ...
                    g(this).hasClass("current") || ("style2" == l || "style1" == l ? (g(this).find("a.ult_a").css({
                        background: c,
                        color: d
                    }), g(this).find(".ult_tab_icon").css({
                        color: i
            ...
            }), g(this).find("ul.ult_tabmenu li a.ult_a").click(function(t) {
                ...
                e.find("ul.ult_tabmenu > li.ult_tab_li").removeClass("current"), "style2" == l || "style1" == l ? (e.find("ul.ult_tabmenu > li.ult_tab_li").find("a").css({
                    background: c,
                    color: d
                ...
                y = ("Slide" == n ? ("style2" == l || "style1" == l ? (a.find("a.ult_a").css({
                    background: f,
                    color: h
                    ...
                    background: f,
                    color: h
                })), e.find(".ult_tabcontent").find("div.ult_tabitemname").not("div.ult_tabitemname:eq(" + i + ")").stop().slideUp(500, function() {
                    0 < u && r()
                }), e.find(".ult_tabcontent").find("div.ult_tabitemname:eq(" + i + ")").stop().slideDown(500, function() {})) : "Fade" == n ? ("style2" == l || "style1" == l ? (a.find("a.ult_a").css({
                    background: f,
                    color: h
                }), a.find(".ult_tab_icon").css({
                    color: p
                    ...
                    background: f,
                    color: h
                })), e.find(".ult_tabcontent").find("div.ult_tabitemname").not("div.ult_tabitemname:eq(" + i + ")").fadeOut(100, function() {
                    0 < u && r()
                }), e.find(".ult_tabcontent").find("div.ult_tabitemname:eq(" + i + ")").fadeIn(1200)) : "Scale" == n ? ("style2" == l || "style1" == l ? (a.find("a.ult_a").css({
                    background: f,
                    color: h
                }), a.find(".ult_tab_icon").css({
                    color: p
                    ...
                    0 < u && r(), e.find(".ult_tabcontent").find("div.ult_tabitemname").not("div.ult_tabitemname:eq(" + i + ")").addClass("scaleTabname"), e.find(".ult_tabcontent").find("div.ult_tabitemname").not("div.ult_tabitemname:eq(" + i + ")").removeClass("scaleTabname2")
                }), e.find(".ult_tabcontent").find("div.ult_tabitemname:eq(" + i + ")").fadeIn(300, function() {
                    e.find(".ult_tabcontent").find("div.ult_tabitemname:eq(" + i + ")").removeClass("scaleTabname"), e.find(".ult_tabcontent").find("div.ult_tabitemname:eq(" + i + ")").addClass("scaleTabname2")
                })) : "Slide-Zoom" == n ? ("style2" == l || "style1" == l ? (a.find("a.ult_a").css({
                    background: f,
                    color: h
                }), a.find(".ult_tab_icon").css({
                    color: p
                    ...
                    background: f,
                    color: h
                })), o = e.find(".ult_tabcontent").find("div.ult_tabitemname:eq(" + i + ")").hasClass("ult_active_tabnme"), 0 == o ? (e.find(".ult_tabcontent").find("div.ult_tabitemname:eq(" + i + ")").hide(10, function() {
                    jQuery(this).addClass("ult_active_tabnme"), e.find(".ult_tabcontent").find("div.ult_tabitemname").not("div.ult_tabitemname:eq(" + i + ")").removeClass("ult_active_tabnme"), e.find(".ult_tabcontent").find("div.ult_tabitemname").not("div.ult_tabitemname:eq(" + i + ")").hide(10), i > s ? jQuery(this).animate({
                        left: "-" + m + "px"
                    }, 10) : jQuery(this).animate({
                        left: m + "px"
                    }, 10), 0 < u && r()
                }), e.find(".ult_tabcontent").find("div.ult_tabitemname:eq(" + i + ")").show(100, function() {
                    jQuery(this).animate({
                        left: "0px"
                    }, 800)
                })) : (e.find(".ult_tabcontent").find("div.ult_tabitemname:eq(" + i + ")").animate({
                    opacity: 1
                }, 1, function() {
                    0 < u && r()
                }), e.find(".ult_tabcontent").find("div.ult_tabitemname:eq(" + i + ")").animate({
                    opacity: 1
                }, 1, function() {}))) : ("style2" == l || "style1" == l ? (a.find("a.ult_a").css({
                    background: f,
                    color: h
                }), a.find(".ult_tab_icon").css({
                    color: p
                    ...
                    background: f,
                    color: h
                })), e.find(".ult_tabcontent").find("div.ult_tabitemname").not("div.ult_tabitemname:eq(" + i + ")").hide(1, function() {
                    0 < u && r()
                }), e.find(".ult_tabcontent").find("div.ult_tabitemname:eq(" + i + ")").show(10)), i), t.preventDefault()
            });
            var i = 0;
            0 < u && r()
        })
    }), jQuery(document).ready(function(o) {
        o(this).find("ul.ult_tabmenu li a.ult_a").click(function(t) {
            o(this).closest("li.ult_tab_li").siblings().each(function(t, e) {
        ...
        jQuery(this).find("a").click(function(t) {
            ...
            if (void 0 !== e && 0 < e.length) {
                ...
                let t = o.attr("href");
                void 0 !== t && "" !== t && (t = t.replace("#", "")), 0 < o.parents(".ult_tabs").length && i == t && setmytime(t)
            }
        }), jQuery(".ult_tabs").each(function() {
            ...
            "" == i && "0" != i && (i = 1);
            let o = jQuery(this).find("ul.ult_tabmenu li.ult_tab_li:nth-child(" + i + ")").find(".ult_a").attr("id");
            e !== t && (o = e), void 0 !== o ? 1 <= o.length && 1 <= i && setmytime(o, !0) : jQuery(this).find(".ult_tabcontent").css({
                display: "none"
            })
        }), jQuery(this).find("ul.ult_tabmenu li a.ult_a").click(function(t) {
            var e = jQuery(this).closest(".ult_tabs").data("animation");
            j = jQuery(this).closest("li.ult_tab_li").index(), "Fade" == e && (i = jQuery(this).closest(".ult_tabs").find("div.ult_tabitemname:eq(" + j + ")").outerHeight(), jQuery(this).closest(".ult_tabs").find(".ult_tabitemname").css({
                position: "absolute",
                left: "0",
                right: "0"
            }), jQuery(this).closest(".ult_tabs").find(".ult_tabcontent").animate({
                height: i
            }, "slow")), "Slide-Horizontal" == e && (i = jQuery(this).closest(".ult_tabs").find("div.ult_tabitemname:eq(" + j + ")").outerHeight(), jQuery(this).closest(".ult_tabs").find(".ult_tabcontent").css({
                overflow: "hidden"
            }), jQuery(this).closest(".ult_tabs").find(".ult_tabcontent").animate({
                height: i
            }, "slow"));
            var i = jQuery(this).closest(".ult_tabs").find("div.ult_tabitemname:eq(" + j + ")");
            jQuery(document).trigger("ultAdvancedTabClickedCarousel", i), jQuery(document).trigger("ultAdvancedTabClickedDualBtn", i)
        })
    }), jQuery(document).ready(function() {
        jQuery(this).find("ul.ult_tabmenu li a.ult_a").click(function(t) {
        ...
        function t() {
            jQuery(".ult-team-member-wrap").each(function(t) {
                ...
                "" != e && (jQuery(window).width() <= e ? (jQuery(this).removeClass("ult-style-2"), jQuery(this).addClass("ult-style-1 ult-responsive")) : jQuery(this).hasClass("ult-responsive") && (jQuery(this).removeClass("ult-style-1 ult-responsive"), jQuery(this).addClass("ult-style-2")))
            })
        }
        ...
        function e() {
            jQuery(".ult-team-member-wrap").each(function(t) {
                ...
                parseFloat(e) < parseFloat(i.height()) ? i.addClass("ult-desc-set-top") : i.hasClass("ult-desc-set-top") && i.removeClass("ult-desc-set-top")
        ...
        }), t(), setTimeout(e, 500), jQuery(".ult-team-member-wrap .ult-team-member-image img").on("load", function() {
            e()
        }), jQuery(window).resize(function() {
            t(), e()
    ...
    function(p) {
        ...
        const s = function(t, e) {
            this.type = this.options = this.enabled = this.timeout = this.hoverState = this.$element = null, this.init("bsf_tooltip", t, e)
        };
        s.DEFAULTS = {
            animation: !0,
            placement: "top",
            ...
            for (let t = o.length; t--;) {
                var s, n = o[t];
                "click" == n ? this.$element.on("click." + this.type, this.options.selector, p.proxy(this.toggle, this)) : "manual" != n && (s = "hover" == n ? "mouseleave" : "focusout", this.$element.on(("hover" == n ? "mouseenter" : "focusin") + "." + this.type, this.options.selector, p.proxy(this.enter, this)), this.$element.on(s + "." + this.type, this.options.selector, p.proxy(this.leave, this)))
            }
            ...
            return (t = p.extend({}, this.getDefaults(), this.$element.data(), t)).delay && "number" == typeof t.delay && (t.delay = {
                show: t.delay,
                hide: t.delay
            }), t
            ...
            const e = t instanceof this.constructor ? t : p(t.currentTarget)[this.type](this.getDelegateOptions()).data("bs." + this.type);
            ...
            if (this.hasContent() && this.enabled && (this.$element.trigger(t), !t.isDefaultPrevented())) {
                ...
                let t = "function" == typeof this.options.placement ? this.options.placement.call(this, c[0], this.$element[0]) : this.options.placement;
                const u = /\s?auto?\s?/i;
                var e = u.test(t);
                e && (t = t.replace(u, "") || "top"), c.detach().css({
                    top: 0,
                    left: 0,
                    display: "block"
                }).addClass(t), this.options.container ? c.appendTo(this.options.container) : c.insertAfter(this.$element);
                ...
                if (e) {
                    ...
                    t = "bottom" == t && i.top + i.height + s - a > l ? "top" : "top" == t && i.top - a - s < 0 ? "bottom" : "right" == t && i.right + o > r ? "left" : "left" == t && i.left - o < e ? "right" : t, c.removeClass(n).addClass(t)
                }
                ...
                p.support.transition && this.$tip.hasClass("fade") ? c.one(p.support.transition.end, s).emulateTransitionEnd(150) : s()
            }
            ...
            isNaN(a) && (a = 0), isNaN(r) && (r = 0), e.top = e.top + a, e.left = e.left + r, p.offset.setOffset(o[0], p.extend({
                using(t) {
                    o.css({
            ...
            if ("top" == t && d != n && (i = !0, e.top = e.top + n - d), /bottom|top/.test(t)) {
                let t = 0;
                e.left < 0 && (t = -2 * e.left, e.left = 0, o.offset(e), l = o[0].offsetWidth, d = o[0].offsetHeight), this.replaceArrow(t - s + l, l, "left")
            ...
            const t = this.tip();
            var e = this.getTitle();
            t.find(".bsf_tooltip-inner")[this.options.html ? "html" : "text"](e), t.removeClass("fade in top bottom left right")
            ...
            if (this.$element.trigger(i), !i.isDefaultPrevented()) return e.removeClass("in"), p.support.transition && this.$tip.hasClass("fade") ? e.one(p.support.transition.end, o).emulateTransitionEnd(150) : o(), this.hoverState = null, this
            ...
            return p.extend({}, "function" == typeof t.getBoundingClientRect ? t.getBoundingClientRect() : {
                width: t.offsetWidth,
            ...
            const e = t ? p(t.currentTarget)[this.type](this.getDelegateOptions()).data("bs." + this.type) : this;
        ...
        p.fn.bsf_tooltip = function(o) {
            return this.each(function() {
                ...
                !e && "destroy" == o || (e || t.data("bs.bsf_tooltip", e = new s(this, i)), "string" == typeof o && e[o]())
            })
        }, p.fn.bsf_tooltip.Constructor = s, p.fn.bsf_tooltip.noConflict = function() {
            return p.fn.bsf_tooltip = t, this
        }, p("[id^=ubtn-]").bsf_tooltip(), p('ul[data-placement=""]').bsf_tooltip("hide")
    }(jQuery),
    function(s) {
        "use strict";
        const n = function(t, e) {
        ...
        n.prototype = {
            ...
            build() {
                const i = this;
                var t;
                !0 === this.showCursor && (this.cursor = s('<span class="typed-cursor">' + this.cursorChar + "</span>"), this.el.after(this.cursor)), this.stringsElement && (this.strings = [], this.stringsElement.hide(), console.log(this.stringsElement.children()), t = this.stringsElement.children(), s.each(t, function(t, e) {
            ...
            typewrite(s, n) {
                if (!0 !== this.stop) {
                    ...
                    a.timeout = setTimeout(function() {
                        ...
                        if ("^" === i.charAt(0)) {
                            let t = 1;
                            /^\^\d+/.test(i) && (i = /\d+/.exec(i)[0], t += i.length, e = parseInt(i)), s = s.substring(0, n) + s.substring(n + t)
                        }
                        if ("html" === a.contentType) {
                            ...
                            if ("<" === o) {
                                let t = "",
                                    e = "";
                                for (e = "<" === o ? ">" : ";"; s.substr(n + 1).charAt(0) !== e && (t += s.substr(n).charAt(0), !(++n + 1 > s.length)););
                                n++, t += e
                            }
                        }
                        a.timeout = setTimeout(function() {
                            var t;
                            n === s.length ? (a.options.onStringTyped(a.arrayPos), a.arrayPos === a.strings.length - 1 && (a.options.callback(), a.curLoop++, !1 === a.loop || a.curLoop === a.loopCount) || (a.timeout = setTimeout(function() {
                                a.backspace(s, n)
                            }, a.backDelay))) : (0 === n && a.options.preStringTyped(a.arrayPos), t = s.substr(0, n + 1), a.attr ? a.el.attr(a.attr, t) : a.isInput ? a.el.val(t) : "html" === a.contentType ? a.el.html(t) : a.el.text(t), n++, a.typewrite(s, n))
                        }, e)
                    }, t)
                }
            },
                ...
                if (!0 !== this.stop) {
                    ...
                    o.timeout = setTimeout(function() {
                        if ("html" === o.contentType && ">" === e.substr(i).charAt(0)) {
                            let t = "";
                            for (;
                                "<" !== e.substr(i - 1).charAt(0) && (t -= e.substr(i).charAt(0), !(--i < 0)););
                            i--, t += "<"
                        }
                        var t = e.substr(0, i);
                        o.attr ? o.el.attr(o.attr, t) : o.isInput ? o.el.val(t) : "html" === o.contentType ? o.el.html(t) : o.el.text(t), i > o.stopNum ? (i--, o.backspace(e, i)) : i <= o.stopNum && (o.arrayPos++, o.arrayPos === o.strings.length ? (o.arrayPos = 0, o.shuffle && (o.sequence = o.shuffleArray(o.sequence)), o.init()) : o.typewrite(o.strings[o.sequence[o.arrayPos]], i))
                    }, t)
                }
            },
            shuffleArray(t) {
                let e, i, o = t.length;
                if (o)
                    for (; --o;) e = t[i = Math.floor(Math.random() * (o + 1))], t[i] = t[o], t[o] = e;
                return t
            },
            reset() {
    ...
    }(window.jQuery), jQuery(document).ready(function(u) {
        let h = "",
            p = "",
            f = "",
            m = "",
        ...
        jQuery(".ult-responsive").each(function(t, e) {
            let i = jQuery(this),
                ...
                d = "",
                c = "";
            void 0 === o && null == o || u.each(u.parseJSON(o), function(t, e) {
                const o = t;
                void 0 !== e && null != e && (e = e.split(";"), jQuery.each(e, function(t, e) {
                    if (void 0 !== e || null != e) {
                        var i = e.split(":");
            ...
            }), "" != c && (b += s + "{" + c + "}"), "" != d && (y += s + "{" + d + "}"), "" != l && (m += s + "{" + l + "}"), "" != r && (f += s + "{" + r + "}"), "" != a && (p += s + "{" + a + "}"), "" != n && (h += s + "{" + n + "}")
        });
        var t = "<style>/** Ultimate: Media Responsive **/ ";
        t += p, t += "@media (max-width: 1199px) { " + f + "}", t += "@media (max-width: 991px)  { " + m + "}", t += "@media (max-width: 767px)  { " + y + "}", t += "@media (max-width: 479px)  { " + b + "}", t += "/** Ultimate: Media Responsive - **/</style>", jQuery("head").append(t)
    }),
    function(l) {
        function d() {
        ...
        l(document).ready(function(t) {
            var e = l(".ult-video").map(function() {
                    return l(this).attr("id")
                }).get(),
                i = l(".ultv-video__outer-wrap").map(function() {
                    return l(this).attr("data-iconbg")
                }).get(),
                o = l(".ultv-video__outer-wrap").map(function() {
                    return l(this).attr("data-overcolor")
                }).get(),
                s = l(".ultv-video__outer-wrap").map(function() {
                    return l(this).attr("data-defaultbg")
                }).get(),
                n = l(".ultv-video__outer-wrap").map(function() {
                    return l(this).attr("data-defaultplay")
                }).get(),
                a = l(".ultv-video").map(function() {
                    return l(this).attr("data-videotype")
                }).get();
            for (let t = e.length - 1; 0 <= t; t--) {
                l("#" + e[t] + " .ultv-video").find(" .ultv-video__outer-wrap").css("color", i[t]), l("#" + e[t] + " .ultv-video").find(" .ultv-youtube-icon-bg").css({
                    fill: s[t]
                }), l("#" + e[t] + " .ultv-video").find(" .ultv-vimeo-icon-bg").css({
                    fill: s[t]
                });
            ...
            for (let t = 0; t <= n.length - 1; t++) "icon" == n[t] ? l(".ultv-video").find(" .ultv-video__outer-wrap").hover(function() {
                const t = l(this);
                t.css("color", t.data("hoverbg"))
            }, function() {
                const t = l(this);
                t.css("color", t.data("iconbg"))
            }) : "defaulticon" == n[t] && ("uv_iframe" == a[t] ? l(".ultv-video").find(" .ultv-video__outer-wrap").hover(function() {
                const t = l(this);
            ...
            }) : "vimeo_video" == a[t] && l(".ultv-video").find(" .ultv-video__outer-wrap").hover(function() {
                const t = l(this);
    ...
    function(l) {
        l(document).ready(function() {
            ...
            l(".ult-video-banner").each(function(t, e) {
                ...
                let s = 0;
                l(e).find("video").get(0).addEventListener("canplay", function() {
                    return !(1 <= s) && (l(e).find("video").get(0).currentTime = o, l(e).find("video").get(0).pause(), void s++)
                });
                var n = l(e).find(".ult-video-banner-overlay").data("overlay"),
                    a = l(e).find(".ult-video-banner-overlay").data("overlay-hover");
                "" != n && (r += "#" + i + " .ult-video-banner-overlay { background:" + n + " }"), "" != a && (r += "#" + i + ".ult-vb-touch-start .ult-video-banner-overlay { background:" + a + " }")
            }), "" != r && l("head").append("<style>" + r + "</style>"), l(document).on("mouseover", ".ult-video-banner", function() {
                ...
                return l(this).hasClass("ult-vb-touch-start") ? (l(this).removeClass("ult-vb-touch-start"), l(this).find("video").get(0).pause(), !1) : (l(this).addClass("ult-vb-touch-start"), void l(this).find("video").get(0).play())
            })
        })
    }(jQuery);