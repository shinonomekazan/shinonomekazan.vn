!(function (t) {
		...
		return "area" === n
			? ((s = (i = t.parentNode).name),
			  !(!t.href || !s || "map" !== i.nodeName.toLowerCase()) &&
					!!(s = T("img[usemap='#" + s + "']")[0]) &&
					o(s))
			: (/^(input|select|textarea|button|object)$/.test(n) ? !t.disabled : ("a" === n && t.href) || e) && o(t);
	}

	function o(t) {
		return (
			T.expr.filters.visible(t) &&
			!T(t)
				.parents()
				.addBack()
				.filter(function () {
		...
		T("<a>").outerWidth(1).jquery ||
			T.each(["Width", "Height"], function (t, i) {
				...
				function a(t, e, i, s) {
					return (
						T.each(n, function () {
							(e -= parseFloat(T.css(t, "padding" + this)) || 0),
								i && (e -= parseFloat(T.css(t, "border" + this + "Width")) || 0),
								s && (e -= parseFloat(T.css(t, "margin" + this)) || 0);
						}),
						e
					);
				}
			...
			zIndex: function (t) {
				...
				if (this.length)
					for (var e, i, s = T(this[0]); s.length && s[0] !== document; ) {
						if (
							("absolute" === (e = s.css("position")) || "relative" === e || "fixed" === e) &&
	...
	(T.cleanData =
		...
		(T.widget = function (t, i, e) {
			...
			return (
				(t = t.split(".")[1]),
				e || ((e = i), (i = T.Widget)),
				(T.expr[":"][(s = h + "-" + t).toLowerCase()] = function (t) {
					return !!T.data(t, s);
				}),
				(T[h] = T[h] || {}),
				(n = T[h][t]),
				...
				n
					? (T.each(n._childConstructors, function (t, e) {
							var i = e.prototype;
				...
				for (e in s[n])
					(i = s[n][e]),
						s[n].hasOwnProperty(e) &&
							void 0 !== i &&
							(T.isPlainObject(i)
								? (t[e] = T.isPlainObject(t[e])
										? T.widget.extend({}, t[e], i)
										: T.widget.extend({}, i))
								: (t[e] = i));
			return t;
		}),
					...
					t
						? this.each(function () {
								...
								return "instance" === i
									? ((n = e), !1)
									: e
									? T.isFunction(e[i]) && "_" !== i.charAt(0)
										? (t = e[i].apply(e, s)) !== e && void 0 !== t
											? ((n = t && t.jquery ? n.pushStack(t.get()) : t), !1)
											: void 0
										: T.error("no such method '" + i + "' for " + o + " widget instance")
									: T.error(
						...
						: (s.length && (i = T.widget.extend.apply(null, [i].concat(s))),
						  this.each(function () {
								var t = T.data(this, a);
		...
		(T.Widget.prototype = {
			...
			_createWidget: function (t, e) {
				(e = T(e || this.defaultElement || this)[0]),
					(this.element = T(e)),
					(this.uuid = r++),
					...
					(this.focusable = T()),
					e !== this &&
						(T.data(e, this.widgetFullName, this),
						this._on(!0, this.element, {
							remove: function (t) {
								t.target === e && this.destroy();
							},
						}),
						(this.document = T(e.style ? e.ownerDocument : e.document || e)),
						(this.window = T(this.document[0].defaultView || this.document[0].parentWindow))),
					(this.options = T.widget.extend({}, this.options, this._getCreateOptions(), t)),
					this._create(),
			...
			option: function (t, e) {
				...
				if ("string" == typeof t)
					if (((o = {}), (t = (i = t.split(".")).shift()), i.length)) {
						for (s = o[t] = T.widget.extend({}, this.options[t]), n = 0; n < i.length - 1; n++)
							(s[i[n]] = s[i[n]] || {}), (s = s[i[n]]);
			...
			_on: function (n, o, t) {
				...
				"boolean" != typeof n && ((t = o), (o = n), (n = !1)),
					t
						? ((o = a = T(o)), (this.bindings = this.bindings.add(o)))
						: ((t = o), (o = this.element), (a = this.widget())),
					T.each(t, function (t, e) {
						function i() {
							if (n || (!0 !== r.options.disabled && !T(this).hasClass("ui-state-disabled")))
			...
			_off: function (t, e) {
				(e = (e || "").split(" ").join(this.eventNamespace + " ") + this.eventNamespace),
					...
					(this.bindings = T(this.bindings.not(t).get())),
					(this.focusable = T(this.focusable.not(t).get())),
					(this.hoverable = T(this.hoverable.not(t).get()));
			},
			_delay: function (t, e) {
				var i = this;
			...
			_trigger: function (t, e, i) {
				...
				return (
					...
					!((T.isFunction(o) && !1 === o.apply(this.element[0], [e].concat(i))) || e.isDefaultPrevented())
				);
			},
		}),
		T.each(
			...
			function (o, a) {
				T.Widget.prototype["_" + o] = function (e, t, i) {
					...
					(t.complete = i),
						...
						n && T.effects && T.effects.effect[s]
							? e[o](t)
							: s !== o && e[s]
	...
	T.widget("ui.mouse", {
		...
		_mouseInit: function () {
			...
			this.element
				...
				.bind("click." + this.widgetName, function (t) {
					if (!0 === T.data(t.target, e.widgetName + ".preventClickEvent"))
						return (
							T.removeData(t.target, e.widgetName + ".preventClickEvent"),
			...
			if (!l) {
				...
				var e = this,
					...
					s =
						...
						T(t.target).closest(this.options.cancel).length;
				return i && !s && this._mouseCapture(t)
					? ((this.mouseDelayMet = !this.options.delay),
					  ...
					  ((this._mouseStarted = !1 !== this._mouseStart(t)), !this._mouseStarted)
							? (t.preventDefault(), !0)
							: (!0 === T.data(t.target, this.widgetName + ".preventClickEvent") &&
									T.removeData(t.target, this.widgetName + ".preventClickEvent"),
		...
		_mouseMove: function (t) {
			if (this._mouseMoved) {
				if (T.ui.ie && (!document.documentMode || document.documentMode < 9) && !t.button)
			...
			return (
				...
				this._mouseStarted &&
					...
					t.target === this._mouseDownEvent.target &&
						T.data(t.target, this.widgetName + ".preventClickEvent", !0),
					this._mouseStop(t)),
				(l = !1)
			);
		},
		...
		(T.position = {
				...
				return (
					...
					T.each(["my", "at"], function () {
						...
						((i =
							...
							(d[this] = [r.exec(i[0])[0], r.exec(i[1])[0]]);
					}),
					1 === _.length && (_[1] = _[0]),
					"right" === d.at[0] ? (m.left += f) : "center" === d.at[0] && (m.left += f / 2),
					...
					this.each(function () {
						...
						"right" === d.my[0] ? (l.left -= r) : "center" === d.my[0] && (l.left -= r / 2),
							"bottom" === d.my[1] ? (l.top -= h) : "center" === d.my[1] && (l.top -= h / 2),
							(l.left += c[0]),
							(l.top += c[1]),
							x || ((l.left = W(l.left)), (l.top = W(l.top))),
							(i = {
								marginLeft: e,
								marginTop: s,
							}),
							...
							d.using &&
								(t = function (t) {
									...
									f < r && z(e + i) < f && (o.horizontal = "center"),
										p < h && z(s + n) < p && (o.vertical = "middle"),
										C(z(e), z(i)) > C(z(s), z(n))
				...
				flip: {
					left: function (t, e) {
						var i = e.within,
							...
							a = -2 * e.offset[0];
						r < 0
							? ((s = t.left + l + i + a + e.collisionWidth - n - s) < 0 || s < z(r)) &&
							  (t.left += l + i + a)
							: 0 < h &&
							  (0 < (o = t.left - e.collisionPosition.marginLeft + l + i + a - o) || z(o) < h) &&
							  (t.left += l + i + a);
					},
					top: function (t, e) {
						var i = e.within,
							...
							a = -2 * e.offset[1];
						r < 0
							? ((s = t.top + l + i + a + e.collisionHeight - n - s) < 0 || s < z(r)) &&
							  (t.top += l + i + a)
							: 0 < h &&
							  (0 < (o = t.top - e.collisionPosition.marginTop + l + i + a - o) || z(o) < h) &&
							  (t.top += l + i + a);
					},
				},
				flipfit: {
			...
			(function () {
				...
				n))
					s.style[t] = n[t];
				s.appendChild(i),
					(e = e || document.documentElement).insertBefore(s, e.firstChild),
	...
	T.widget("ui.resizable", T.ui.mouse, {
		...
		_create: function () {
			...
			if (
				...
				for (
					...
					(i = T.trim(t[e])),
						(s = T("<div class='ui-resizable-handle " + ("ui-resizable-" + i) + "'></div>")).css({
							zIndex: o.zIndex,
						}),
				...
				for (e in ((t = t || this.element), this.handles))
					this.handles[e].constructor === String
						...
						: (this.handles[e].jquery || this.handles[e].nodeType) &&
						  ((this.handles[e] = T(this.handles[e])),
						  this._on(this.handles[e], {
								mousedown: n._mouseDown,
						  })),
						this.elementIsWrapper &&
							this.originalElement[0].nodeName.match(/^(textarea|input|select|button)$/i) &&
							((i = T(this.handles[e], this.element)),
		...
		_mouseStart: function (t) {
			...
			return (
				...
				s.containment && ((e += T(s.containment).scrollLeft() || 0), (i += T(s.containment).scrollTop() || 0)),
		...
		_mouseStop: function (t) {
			...
			return (
				this._helper &&
					...
					(i = parseInt(o.element.css("left"), 10) + (o.position.left - o.originalPosition.left) || null),
					(s = parseInt(o.element.css("top"), 10) + (o.position.top - o.originalPosition.top) || null),
					n.animate ||
						this.element.css(
							T.extend(e, {
								top: s,
		...
		T.ui.plugin.add("resizable", "grid", {
			resize: function () {
				...
				(i.grid = r),
					...
					g && (f -= l),
					/^(se|s|e)$/.test(a)
						? ((e.size.width = u), (e.size.height = f))
						: /^(ne)$/.test(a)
						? ((e.size.width = u), (e.size.height = f), (e.position.top = o.top - d))
						: /^(sw)$/.test(a)
						? ((e.size.width = u), (e.size.height = f), (e.position.left = o.left - c))
						: ((f - l <= 0 || u - h <= 0) && (t = e._getPaddingPlusBorderDimensions(this)),
						  0 < f - l
								? ((e.size.height = f), (e.position.top = o.top - d))
								: ((f = l - t.height), (e.size.height = f), (e.position.top = o.top + n.height - f)),
						  0 < u - h
								? ((e.size.width = u), (e.position.left = o.left - c))
								: ((u = h - t.width), (e.size.width = u), (e.position.left = o.left + n.width - u)));
			},
		});
	T.ui.resizable,
			...
			_create: function () {
				...
				this.element.addClass("ui-selectable"),
					...
					(this.refresh = function () {
						(t = T(e.options.filter, e.element[0])).addClass("ui-selectee"),
							t.each(function () {
								var t = T(this),
									e = t.offset();
			...
			_mouseStart: function (i) {
				...
				(this.opos = [i.pageX, i.pageY]),
					this.options.disabled ||
						((this.selectees = T(t.filter, this.element[0])),
						this._trigger("start", i),
						T(t.appendTo).append(this.helper),
						this.helper.css({
							left: i.pageX,
							top: i.pageY,
							width: 0,
					...
					return (
						...
						this.selectees.each(function () {
							...
							t &&
								...
								("touch" === n.tolerance
									? (e = !(t.left > r || t.right < o || t.top > h || t.bottom < a))
									: "fit" === n.tolerance &&
									  (e = t.left > o && t.right < r && t.top > a && t.bottom < h),
								e
									? (t.selected && (t.$element.removeClass("ui-selected"), (t.selected = !1)),
									  t.unselecting &&
											(t.$element.removeClass("ui-unselecting"), (t.unselecting = !1)),
									  t.selecting ||
									...
									: (t.selecting &&
											((i.metaKey || i.ctrlKey) && t.startselected
												...
												: (t.$element.removeClass("ui-selecting"),
												  (t.selecting = !1),
												  t.startselected &&
														(t.$element.addClass("ui-unselecting"), (t.unselecting = !0)),
												  s._trigger("unselecting", i, {
														unselecting: t.element,
												  }))),
									  t.selected &&
		...
		T.widget("ui.accordion", {
			...
			_setOption: function (t, e) {
				"active" !== t
					? ("event" === t &&
					  ...
					  "disabled" === t &&
							(this.element.toggleClass("ui-state-disabled", !!e).attr("aria-disabled", e),
			...
			_animate: function (t, i, e) {
				...
				return (
					(n = (n = "string" == typeof d ? d : n) || d.easing || c.easing),
					(o = (o = "number" == typeof d ? d : o) || d.duration || c.duration),
					i.length
						? t.length
		...
		T.widget("ui.tabs", {
			...
			_panelKeydown: function (t) {
				this._handlePageNav(t) ||
					(t.ctrlKey && t.keyCode === T.ui.keyCode.UP && (t.preventDefault(), this.active.focus()));
			},
			_handlePageNav: function (t) {
				return t.altKey && t.keyCode === T.ui.keyCode.PAGE_UP
					? (this._activate(this._focusNextTab(this.options.active - 1, !1)), !0)
					: t.altKey && t.keyCode === T.ui.keyCode.PAGE_DOWN
					? (this._activate(this._focusNextTab(this.options.active + 1, !0)), !0)
					: void 0;
			},
			_findNextTab: function (t, e) {
				var i = this.tabs.length - 1;
				for (; -1 !== T.inArray((t = (t = i < t ? 0 : t) < 0 ? i : t), this.options.disabled); )
					t = e ? t + 1 : t - 1;
				return t;
			},
			...
			_setupDisabled: function (t) {
				...
				for (var e, i = 0; (e = this.tabs[i]); i++)
					!0 === t || -1 !== T.inArray(i, t)
						? T(e).addClass("ui-state-disabled").attr("aria-disabled", "true")
						: T(e).removeClass("ui-state-disabled").removeAttr("aria-disabled");
			...
			_eventHandler: function (t) {
				...
				t.preventDefault(),
					s.hasClass("ui-state-disabled") ||
						...
						r.length || a.length || T.error("jQuery UI Tabs: Mismatching fragment identifier."),
			...
			_toggle: function (t, e) {
				...
				(this.running = !0),
					n.length && this.options.hide
						...
						: (e.oldTab.closest("li").removeClass("ui-tabs-active ui-state-active"), n.hide(), a()),
			...
			load: function (t, s) {
				...
				this._isLocal(t[0]) ||
					((this.xhr = T.ajax(this._ajaxSettings(t, s, r))),
					this.xhr &&
		...
		T.widget("ui.tooltip", {
			...
			_removeDescribedBy: function (t) {
				...
				-1 !== e && i.splice(e, 1),
					...
					(i = T.trim(i.join(" "))) ? t.attr("aria-describedby", i) : t.removeAttr("aria-describedby");
			},
			_create: function () {
				this._on({
					mouseover: "open",
					...
					t &&
						...
						e.parents().each(function () {
							...
							e.data("ui-tooltip-open") &&
								(((t = T.Event("blur")).target = t.currentTarget = this), i.close(t, !0)),
								e.attr("title") &&
									(e.uniqueId(),
									(i.parents[this.id] = {
										element: this,
			...
			_open: function (t, e, i) {
				var s,
					...
					o,
					a,
					r = T.extend({}, this.options.position);
			...
			_registerCloseHandlers: function (t, e) {
				var i = {
					keyup: function (t) {
						t.keyCode === T.ui.keyCode.ESCAPE &&
							(((t = T.Event(t)).currentTarget = e[0]), this.close(t, !0));
					},
				};
				e[0] !== this.element[0] &&
					(i.remove = function () {
				...
				n
					? ((e = n.tooltip),
					  n.closing ||
							...
							t &&
								"mouseleave" === t.type &&
								T.each(this.parents, function (t, e) {
			...
			_tooltip: function (t) {
				var e = T("<div>")
						.attr("role", "tooltip")
						.addClass(
							"ui-tooltip ui-widget ui-corner-all ui-widget-content " + (this.options.tooltipClass || "")
						),
	...
	function q(t, e, i, s) {
		return (
			...
			T.isFunction((e = null == e ? {} : e)) && ((s = e), (i = null), (e = {})),
			("number" != typeof e && !T.fx.speeds[e]) || ((s = i), (i = e), (e = {})),
			T.isFunction(i) && ((s = i), (i = null)),
			e && T.extend(t, e),
			(i = i || e.duration),
			(t.duration = T.fx.off
				? 0
	...
	function B(t) {
		return (
			...
			"number" == typeof t ||
			T.fx.speeds[t] ||
			("string" == typeof t && !T.effects.effect[t]) ||
			T.isFunction(t) ||
	...
	(T.effects = {
		...
		(_ = d("<p>")[0]),
		(y = d.each),
		(_.style.cssText = "background-color:rgba(1,1,1,.5)"),
		(w.rgba = -1 < _.style.backgroundColor.indexOf("rgba")),
		y(v, function (t, e) {
			(e.cache = "_" + t),
				(e.props.alpha = {
					idx: 3,
		...
		((m.fn = d.extend(m.prototype, {
			parse: function (n, t, e, i) {
				...
				return (
					...
					"string" === s
						? this.parse(k(n) || f._default)
						: "array" === s
						? (y(v.rgba.props, function (t, e) {
								a[e.idx] = M(n[e.idx], e);
						  }),
						  this)
						: "object" === s
		...
		(v.hsla.from = function (t) {
			...
			var e = t[0] / 360,
				...
				s = 2 * s - i;
			return [
				Math.round(255 * R(s, i, e + 1 / 3)),
				Math.round(255 * R(s, i, e)),
				Math.round(255 * R(s, i, e - 1 / 3)),
				t,
			];
		}),
				...
				y(o, function (a, r) {
					m.fn[a] ||
						(m.fn[a] = function (t) {
							...
							return "undefined" === i
								? o
								: ("function" === i && ((t = t.call(this, o)), (i = d.type(t))),
								  null == t && r.empty
										? this
										: ("string" === i &&
												(e = p.exec(t)) &&
					...
					(e = e.map(function () {
						return (
							...
							(this.diff = (function (t, e) {
								...
								for (i in e)
									(s = e[i]),
										t[i] !== s && (D[i] || (!T.fx.step[i] && isNaN(parseFloat(s))) || (n[i] = s));
								return n;
							})(this.start, this.end)),
							this
						);
		...
		T.extend(T.effects, {
			...
			restore: function (t, e) {
				for (var i, s = 0; s < e.length; s++)
					null !== e[s] && (void 0 === (i = t.data(P + e[s])) && (i = ""), t.css(e[s], i));
			},
			...
			createWrapper: function (i) {
				...
				return (
					i.wrap(t),
					(i[0] !== n && !T.contains(i[0], n)) || T(n).focus(),
					(t = i.parent()),
			...
			removeWrapper: function (t) {
				...
				return (
					t.parent().is(".ui-effects-wrapper") &&
						(t.parent().replaceWith(t), (t[0] !== e && !T.contains(t[0], e)) || T(e).focus()),
					t
				);
			},
		...
		(N = {}),
		T.each(["Quad", "Cubic", "Quart", "Quint", "Expo"], function (e, t) {
			N[t] = function (t) {
	...
	T.effects,
		(T.effects.effect.blind = function (t, e) {
			var i,
				s,
				n = T(this),
				...
				u = {},
				f = "show" === a;
			n.parent().is(".ui-effects-wrapper") ? T.effects.save(n.parent(), o) : T.effects.save(n, o),
				n.show(),
				(s = (i = T.effects.createWrapper(n).css({
					overflow: "hidden",
				}))[l]()),
				(r = parseFloat(i.css(c)) || 0),
				(u[l] = f ? s : 0),
				d ||
					(n
		...
		(T.effects.effect.bounce = function (t, e) {
			...
			for (
				...
				((s = {})[g] = (m ? "-=" : "+=") + d), o.animate(s, f, p).animate(n, f, p), (d = h ? 2 * d : d / 2);
			h &&
				(((s = {
					opacity: 0,
				})[g] = (m ? "-=" : "+=") + d),
				...
				1 < c && t.splice.apply(t, [1, 0].concat(t.splice(c, 1 + r))),
				o.dequeue();
		}),
		(T.effects.effect.clip = function (t, e) {
			...
			T.effects.save(s, n),
				s.show(),
				(i = T.effects.createWrapper(s).css({
					overflow: "hidden",
				})),
				(i = (a = "IMG" === s[0].tagName ? i : s)[r]()),
				o && (a.css(r, 0), a.css(h, i / 2)),
				(l[r] = o ? i : 0),
				(l[h] = o ? 0 : i / 2),
				a.animate(l, {
					queue: !1,
		...
		(T.effects.effect.drop = function (t, e) {
			...
			T.effects.save(i, s),
				...
				(a = t.distance || i["top" == r ? "outerHeight" : "outerWidth"](!0) / 2),
				o && i.css("opacity", 0).css(r, "pos" == h ? -a : a),
				(l[r] = (o ? ("pos" == h ? "+=" : "-=") : "pos" == h ? "-=" : "+=") + a),
				i.animate(l, {
					queue: !1,
					duration: t.duration,
		...
		(T.effects.effect.explode = function (t, e) {
			...
			for (i = 0; i < h; i++)
				for (o = u.top + i * p, r = i - (h - 1) / 2, s = 0; s < l; s++)
					(n = u.left + s * f),
						(a = s - (l - 1) / 2),
						c
							.clone()
		...
		(T.effects.effect.fold = function (t, e) {
			...
			T.effects.save(i, s),
				i.show(),
				(n = T.effects.createWrapper(i).css({
					overflow: "hidden",
				})),
				(c = c ? [n.width(), n.height()] : [n.height(), n.width()]),
				h && (r = (parseInt(h[1], 10) / 100) * c[a ? 0 : 1]),
				o &&
					n.css(
						l
							? {
				...
				(f[d[0]] = o ? c[0] : r),
				(p[d[1]] = o ? c[1] : 0),
				n.animate(f, u, t.easing).animate(p, u, t.easing, function () {
		...
		(T.effects.effect.size = function (o, t) {
			...
			"show" === n && r.show(),
				...
				"toggle" === o.mode && "show" === n
					? ((r.from = o.to || m), (r.to = o.from || e))
					: ((r.from = o.from || ("show" === n ? m : e)), (r.to = o.to || ("hide" === n ? m : e))),
				(a = {
					from: {
				...
				("box" !== u && "both" !== u) ||
					(a.from.y !== a.to.y &&
						((g = g.concat(l)),
						(r.from = T.effects.setTransition(r, l, a.from.y, r.from)),
						(r.to = T.effects.setTransition(r, l, a.to.y, r.to))),
					a.from.x !== a.to.x &&
						((g = g.concat(c)),
						(r.from = T.effects.setTransition(r, c, a.from.x, r.from)),
						(r.to = T.effects.setTransition(r, c, a.to.x, r.to)))),
				("content" !== u && "both" !== u) ||
					(a.from.y !== a.to.y &&
						((g = g.concat(s).concat(h)),
						(r.from = T.effects.setTransition(r, s, a.from.y, r.from)),
						(r.to = T.effects.setTransition(r, s, a.to.y, r.to)))),
				T.effects.save(r, g),
				r.show(),
				T.effects.createWrapper(r),
				r.css("overflow", "hidden").css(r.from),
				f &&
					((f = T.effects.getBaseline(f, e)),
					(r.from.top = (e.outerHeight - r.outerHeight()) * f.y),
					(r.from.left = (e.outerWidth - r.outerWidth()) * f.x),
					(r.to.top = (e.outerHeight - r.to.outerHeight) * f.y),
					(r.to.left = (e.outerWidth - r.to.outerWidth) * f.x)),
				r.css(r.from),
				("content" !== u && "both" !== u) ||
					...
					r.find("*[width]").each(function () {
						...
						d && T.effects.save(t, h),
							...
							a.from.y !== a.to.y &&
								((t.from = T.effects.setTransition(t, l, a.from.y, t.from)),
								(t.to = T.effects.setTransition(t, l, a.to.y, t.to))),
							a.from.x !== a.to.x &&
								((t.from = T.effects.setTransition(t, c, a.from.x, t.from)),
								(t.to = T.effects.setTransition(t, c, a.to.x, t.to))),
							t.css(t.from),
		...
		(T.effects.effect.pulsate = function (t, e) {
			var i,
				...
				c = s.queue(),
				n = c.length;
			for ((!o && s.is(":visible")) || (s.css("opacity", 0).show(), (l = 1)), i = 1; i < r; i++)
				s.animate(
					{
						opacity: l,
					},
			...
			s.animate(
				...
				1 < n && c.splice.apply(c, [1, 0].concat(c.splice(n, 1 + r))),
				s.dequeue();
		}),
		(T.effects.effect.shake = function (t, e) {
			...
			for (
				T.effects.save(s, n),
					...
					p[d] = (u ? "+=" : "-=") + 2 * r,
					g[d] = (u ? "-=" : "+=") + 2 * r,
					s.animate(f, c, t.easing),
					i = 1;
				i < h;
				i++
			)
				s.animate(p, c, t.easing).animate(g, c, t.easing);
			s
				...
				1 < a && m.splice.apply(m, [1, 0].concat(m.splice(a, 1 + l))),
				s.dequeue();
		}),
		(T.effects.effect.slide = function (t, e) {
			...
			T.effects.save(i, s),
				i.show(),
				(a = t.distance || i["top" == r ? "outerHeight" : "outerWidth"](!0)),
				T.effects.createWrapper(i).css({
					overflow: "hidden",
				}),
				o && i.css(r, h ? (isNaN(a) ? "-" + a : -a) : a),
				(l[r] = (o ? (h ? "+=" : "-=") : h ? "-=" : "+=") + a),
				i.animate(l, {
					queue: !1,
					duration: t.duration,
