	...
	jQuery(document).ready(function () {
		...
		function W(a, r) {
			...
			if (void 0 !== t && "true" == t.toString()) {
				...
				if ("triangle_seperator" == o) seperator_class = "ult-trinalge-seperator";
					...
					var f =
						((f = (f = i).replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, function (t, e, a, r) {
							return e + e + a + a + r + r;
						})),
					...
					0 != s &&
						...
						"none" != l &&
							...
							(temp_border_before =
								"border-top: " + temp_border_line + "; border-right: " + temp_border_line + ";"),
							(temp_border_after =
								"border-top: " + temp_border_line + "; border-left: " + temp_border_line + ";")),
				...
				void 0 !== n && "" != n && 0 != n && (e = parseInt(n)),
					...
					"ult-no-shape-seperator" != seperator_class &&
						"ult-rounded-split-seperator-wrapper" != seperator_class &&
						0 == t &&
						((_ = "<style>." + b + " .ult-main-seperator-inner:after { " + shape_css + " }</style>"),
					...
					"top_bottom_seperator" == u
						...
						: (g =
								...
								"</div>"),
					r.prepend(g),
					(seperator_css = "<style>." + b + " .ult-main-seperator-inner { " + seperator_css + " }</style>"),
					"" != h &&
						((h = "<style>." + b + " .ult-main-seperator-inner { " + h + " }</style>"),
						(seperator_css += h)),
					"" != v &&
						((g = p / 2),
						"none_seperator" == o || "circle_svg_seperator" == o || "triangle_svg_seperator" == o
							? (seperator_css +=
									"<style>." +
									b +
							...
							"multi_triangle_seperator" == o &&
								jQuery(".ult-multi-trianle").each(function (t, e) {
									...
									B(e).hasClass("top_seperator") ||
										(B(e).hasClass("bottom_seperator") && B(e).css("bottom", a - 1));
								});
						}, 300)),
					...
					jQuery(this).each(function () {
						...
						(void 0 !== P && "" !== P) || (P = "wpb_row"),
							...
							d.data("multi-color-overlay") &&
								((M = d.data("multi-color-overlay")), (I = d.data("multi-color-overlay-opacity")));
						let B =
							(overlay_color_html =
						...
						void 0 !== c &&
							...
							("" != v &&
								...
								void 0 !== b &&
									"" != b &&
									(overlay_pattern_attachment_css = "background-attachment:" + b + ";"),
								(overlay_pattern_html =
							...
							"" != u &&
								(overlay_color_html =
									'<div class="upb_bg_overlay" style="background-color:' + u + ';"></div>'),
							"" != M &&
								(overlay_multi_color_html =
									'<div class="upb_bg_overlay ' + M + '" style="opacity:' + I + ';"></div>'),
							(B = overlay_color_html + overlay_pattern_html + overlay_multi_color_html)),
							0 != l ? l : (l = ""),
							(h =
								1 == L || "enable" == A
									? (d.prev().is("p") || d.prev().is("style") ? d.prev() : d).prev()
						...
						!(function () {
							...
							(e = resize_selector.parents("upb_video_class").outerHeight()),
								...
								a.offset() &&
									(a.offset().left, resize_selector.offset() && resize_selector.offset().left);
							let r = t,
								o,
								s = e,
								i,
							...
							"" != z && (d.addClass("ult-vc-hide-row"), d.attr("data-hide-row", z)),
							d.attr("data-rtl", k),
							d.addClass("upb_video_class"),
							d.attr("data-row-effect-mobile-disable", Q),
							"fadeout_row_value" == y &&
								(d.addClass("vc-row-fade"), d.attr("data-fadeout-percentage", w)),
						...
						"display_control" == m &&
							...
							"browser_size" == n &&
								...
								d.find(".upb_video-text-wrapper").find(".upb_video-text").addClass(u)),
							"parallax_content_value" == x &&
								(d.addClass("vc-row-translate"),
								d.attr("data-parallax-content-sense", j),
								d.wrapInner('<div class="vc-row-translate-wrapper ' + u + '"></div>'),
								(j = d.css("padding-top")),
						...
						if (
							...
							"loop" == r && (r = !0),
								...
								H.attr("data-start", i),
								H.attr("data-stop", l),
								!0 === g && (H.addClass("enable-on-viewport"), H.addClass("youtube-video"), E());
						} else if ("vimeo" == T)
							(t = t.substring(t.indexOf("vimeo.com/") + 10, t.indexOf("vimeo.com/") + 18)),
							...
							if (
								...
								"display_control" != m &&
									("" != s && H.parent().find(".video-controls").hide(), H.remove());
							else {
								if (
									(jQuery("<source/>", {
										type: "video/mp4",
									...
									let t = "";
									e.match(/.ogg/i) ? (t = "video/ogg") : e.match(/.webm/i) && (t = "video/webm"),
										"" != t &&
											jQuery("<source/>", {
												type: t,
												src: e,
								...
								"muted" == a &&
									...
									!0 === g
										? (H.addClass("enable-on-viewport"), H.addClass("hosted-video"), E())
										: "autoplay" == o &&
										  H.attr({
												autoplay: o,
										  });
					...
					jQuery(this).each(function () {
						...
						(void 0 !== P && "" !== P) || (P = "wpb_row"),
							...
							s.data("multi-color-overlay") &&
								((M = s.data("multi-color-overlay")), (I = s.data("multi-color-overlay-opacity")));
						let B =
							(overlay_color_html =
							overlay_pattern_html =
							overlay_multi_color_html =
						...
						void 0 !== u &&
							...
							"" != c &&
								(overlay_color_html =
									'<div class="upb_bg_overlay" style="background-color:' + c + ';"></div>'),
							"" != M &&
								(overlay_multi_color_html =
									'<div class="upb_bg_overlay ' + M + '" style="opacity:' + I + ';"></div>'),
							(B = overlay_color_html + overlay_pattern_html + overlay_multi_color_html)),
							(h =
								1 == L || "enable" == A
									? (s.prev().is("p") || s.prev().is("style") ? s.prev() : s).prev()
						...
						"browser_size" == d &&
							...
							s.parent().find(".upb-background-text-wrapper").addClass("full-browser-size"),
							s.parent().find(".upb-background-text-wrapper").find(".upb-background-text").addClass(c)),
							"parallax_content_value" == f &&
								(h.addClass("vc-row-translate"),
								h.attr("data-parallax-content-sense", y),
								h.wrapInner('<div class="vc-row-translate-wrapper ' + c + '"></div>'),
								(y = h.css("padding-top")),
								(c = h.css("padding-bottom")),
								h.find(".vc-row-translate-wrapper").css({
									"padding-top": y,
									"padding-bottom": c,
								}),
								void 0 !== h[0] &&
									...
									h[0].style.setProperty("padding-bottom", "0px", "important"))),
							"" != k && (h.addClass("ult-vc-hide-row"), h.attr("data-hide-row", k)),
							h.attr("data-rtl", C),
							...
							"fadeout_row_value" == g &&
								(s.addClass("vc-row-fade"), s.attr("data-fadeout-percentage", m)),
						...
						const O = function () {
							...
							(wh = jQuery(window).height()),
								...
								"browser_size" == d &&
									((o = s.parent().find(".upb-background-text").height()) > wh && (wh = o),
				...
				return (
					jQuery(this).each(function () {
						...
						(void 0 !== f && "" !== f) || (f = "wpb_row"),
							...
							void 0 === w && (w = "disable"),
							s.data("multi-color-overlay") &&
								((g = s.data("multi-color-overlay")), (m = s.data("multi-color-overlay-opacity"))),
							(y =
								1 == x || "enable" == w
									? (s.prev().is("p") || s.prev().is("style") ? s.prev() : s).prev()
						...
						void 0 !== e &&
							...
							("" != r &&
								...
								void 0 !== d &&
									"" != d &&
									(overlay_pattern_attachment_css = "background-attachment:" + d + ";"),
								(overlay_pattern_html =
									'<div class="upb_bg_overlay_pattern" style="background-image:url(' +
									r +
									"); opacity:" +
							...
							"" != a &&
								(overlay_color_html =
									'<div class="upb_bg_overlay" style="background-color:' + a + ';"></div>'),
							"" != g &&
								(overlay_multi_color_html =
									'<div class="upb_bg_overlay ' + g + '" style="opacity:' + m + ';"></div>'),
							(Q = overlay_color_html + overlay_pattern_html + overlay_multi_color_html)),
							"browser_size" == i &&
								(y.wrapInner(
									'<div class="upb-background-text-wrapper"><div class="upb-background-text"></div></div>'
								),
								y.find(".upb-background-text-wrapper").find(".upb-background-text").addClass(j),
								y.addClass("full-browser-size")),
							"parallax_content_value" == u &&
								(y.addClass("vc-row-translate"),
								y.attr("data-parallax-content-sense", v),
								y.wrapInner('<div class="vc-row-translate-wrapper ' + j + '"></div>'),
								(v = y.css("padding-top")),
								...
								void 0 !== y[0] &&
									...
									y[0].style.setProperty("padding-bottom", "0px", "important"))),
							"" != _ && (y.addClass("ult-vc-hide-row"), y.attr("data-hide-row", _)),
							y.attr("data-rtl", b),
							...
							"fadeout_row_value" == p &&
								(s.addClass("vc-row-fade"), s.attr("data-fadeout-percentage", c)),
							s.css("background-image", ""),
							(s = s.find(".upb_row_bg")),
				...
				return (
					jQuery(this).each(function () {
						...
						(void 0 !== y && "" !== y) || (y = "wpb_row"),
							...
							void 0 === f && (f = "disable"),
							s.data("multi-color-overlay") &&
								((b = s.data("multi-color-overlay")), (g = s.data("multi-color-overlay-opacity"))),
							(m =
								1 == w || "enable" == f
									? (s.prev().is("p") || s.prev().is("style") ? s.prev() : s).prev()
						...
						if (
							(void 0 !== d &&
								...
								("" != p &&
									...
									void 0 !== v &&
										"" != v &&
										(overlay_pattern_attachment_css = "background-attachment:" + v + ";"),
									(overlay_pattern_html =
										'<div class="upb_bg_overlay_pattern" style="background-image:url(' +
										p +
										"); opacity:" +
								...
								"" != n &&
									(overlay_color_html =
										'<div class="upb_bg_overlay" style="background-color:' + n + ';"></div>'),
								"" != b &&
									(overlay_multi_color_html =
										'<div class="upb_bg_overlay ' + b + '" style="opacity:' + g + ';"></div>'),
								(j = overlay_color_html + overlay_pattern_html + overlay_multi_color_html)),
							"browser_size" == i
								? (m.wrapInner(
										'<div class="upb-background-text-wrapper"><div class="upb-background-text"></div></div>'
								  ),
								  m.find(".upb-background-text-wrapper").find(".upb-background-text").addClass(x))
								: 0,
							"" != h && (m.addClass("ult-vc-hide-row"), m.attr("data-hide-row", h)),
							m.attr("data-rtl", _),
							"parallax_content_value" == r &&
								(m.addClass("vc-row-translate"),
								m.wrapInner('<div class="vc-row-translate-wrapper ' + x + '"></div>'),
							...
							"fadeout_row_value" == e &&
								(s.addClass("vc-row-fade"), s.attr("data-fadeout-percentage", a)),
							s.css("background-image", ""),
							(s = s.find(".upb_row_bg")),
							s.css({
								background: t,
				...
				if (
					...
					(e =
						d < 4.4 || "enable" == n
							...
							: jQuery(e).prevAll("." + l + ":first")).css("position", "relative"),
					void 0 === e[0])
				)
					return !1;
				e.attr("row-effect-mobile-disable", i),
					"fadeout_row_value" == a && (e.addClass("vc-row-fade"), e.data("fadeout-percentage", r)),
					"parallax_content_value" == o &&
						...
						e.find(".vc-row-translate-wrapper").css({
							"padding-top": o,
							"padding-bottom": s,
						}),
						void 0 !== e[0] &&
				...
				jQuery(".upb_video-bg").each(function (t, e) {
					...
					if (
						((l =
							void 0 !== o && "enable" !== o
								...
								: jQuery(this).parent()),
						"true" == l.attr("data-vc-full-width") || 1 == l.attr("data-vc-full-width")
						...
						(i = jQuery("body")), jQuery(this).parents(".upb_video_class").css("overflow", "visible");
					...
					/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)
						...
						: "browser_size" == a &&
						  ...
						  l.find(".upb-background-text-wrapper").addClass("full-browser-size"),
						  l.css("min-height", s + "px"),
						  0 < l.find(".upb_video-text-wrapper").length &&
								(l.find(".upb_video-text-wrapper").addClass("full-browser-size"),
		...
		function e() {
			jQuery(".ult-vc-seperator").each(function (t, e) {
				...
				if (
					("ex-full" ==
						(o = void 0 === o ? jQuery(this).parent().find(".upb_video-bg").data("bg-override") : o) ||
						"full" == o ||
						"browser_size" == o) &&
					1 == a
				) {
		...
		t(),
			...
			jQuery(".vcpb-animated").each(function (t, a) {
				...
				if (
					...
					let t = 10;
					"" != jQuery(this).attr("data-parallax_sense") && (t = jQuery(this).attr("data-parallax_sense")),
						(t = 100 - t);
					...
					setInterval(function (t) {
						"right-animation" == o || "bottom-animation" == o ? --e : (e += 1),
							jQuery(a).css("backgroundPosition", "h" == s ? e + "px 0" : "0 " + e + "px");
					}, t);
				}
			});
	});
